...
{
    public class WitcI : ModItem//血晶之魂是物件名称
    {
        // Token: 0x0600462B RID: 17963 RVA: 0x0027BBA8 File Offset: 0x00279DA8
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("一阶巫毒符咒");
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if(mplayer.MagicCool == 0)
            {
                ...
                Projectile.NewProjectile(player.Center.X, player.Center.Y, v2.X, v2.Y, Mod.Find<ModProjectile>("SpiritMark").Type, 20, 0.5f, Main.myPlayer, 360, 25f);
