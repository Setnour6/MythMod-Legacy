...
{
    public class MeteIII : ModItem//血晶之魂是物件名称
    {
        // Token: 0x0600462B RID: 17963 RVA: 0x0027BBA8 File Offset: 0x00279DA8
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("三阶火陨符咒");
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if(mplayer.MagicCool == 0)
            {
                for(int t = 0;t < 10;t++)
                {
                    ...
                    Projectile.NewProjectile(v1.X + Main.rand.Next(-200, 200), v1.Y - 1000 + Main.rand.Next(-200,600), v2.X, v2.Y, Mod.Find<ModProjectile>("FireBall").Type, 320, 0.5f, Main.myPlayer, 10f, 25f);
                }
