        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if(mplayer.MagicCool == 0)
            {
                for(int t = 0;t < 10;t++)
                {
                    ...
                    Projectile.NewProjectile(v1.X + Main.rand.Next(-200, 200), v1.Y - 1000 + Main.rand.Next(-200,600), v2.X, v2.Y, mod.ProjectileType("FireBall"), 320, 0.5f, Main.myPlayer, 10f, 25f);
                }
