...
{
    public class LazaI : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("一阶激光雨符咒");
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if(mplayer.MagicCool == 0)
            {
                for(int t = 0;t < 24;t++)
                {
                    ...
                    int num = Projectile.NewProjectile(v1.X + Main.rand.Next(-600, 600), v1.Y - 1000 + Main.rand.Next(-900, 200), v2.X * 4f, v2.Y * 4f, 83, item.damage, 0.5f, Main.myPlayer, 10f, 25f);
