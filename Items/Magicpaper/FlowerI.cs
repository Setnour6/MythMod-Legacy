...
{
    public class FlowerI : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("一阶绽花符咒");
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if(mplayer.MagicCool == 0)
            {
                ...
                for (int t = 0; t < 40; t++)
                { 
                    Vector2 v2 = new Vector2(0, Main.rand.NextFloat(0, 10f)).RotatedByRandom(Math.PI * 2d);
                ...
                for (int i = 0; i <= 16; i++)
                {
                    ...
                    double num2 = Math.Sin((double)num1 * Math.PI) * num4 / 140f;
                    double num3 = Math.Cos((double)num1 * Math.PI) * num4 / 140f;
