        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if (mplayer.MagicCool == 0)
            {
                ...
                for (int k = 0; k <= 40; k++)
                {
                    ...
                    int num4 = Projectile.NewProjectile(player.Center.X, player.Center.Y, v.X * 0.06f, v.Y * 0.06f, base.Mod.Find<ModProjectile>("FreezeLoop").Type, Item.damage, Item.knockBack, Main.myPlayer, 0f, 480/*决定了冰冻时间*/);
