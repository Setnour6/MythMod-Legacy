...
namespace MythMod.Items.Foods.Drinks
{
    public class TequilaSunriseDrink : ModItem
	{
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if (!player.HasBuff(mod.BuffType("TequilaSunrise")))
            {
                player.AddBuff(base.mod.BuffType("TequilaSunrise"), 14400, true);
                item.stack--;
            }
            return player.HasBuff(mod.BuffType("TequilaSunrise"));
        }
    }
}
