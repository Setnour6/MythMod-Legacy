...
namespace MythMod.Items.Banners
{
    ...
    public class FloatStoneBanner : ModItem
    {
        // Token: 0x06001475 RID: 5237 RVA: 0x000082F6 File Offset: 0x000064F6
        public override void SetStaticDefaults()
        {
            // base.DisplayName.SetDefault("火山浮石Banner");
            base.DisplayName.AddTranslation(GameCulture.Chinese, "火山浮石旗");
        }
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
        {
            ...
            spriteBatch.Draw(base.Mod.GetTexture("Items/Banners/火山浮石BannerGlow"), base.Item.Center - Main.screenPosition, null, Color.White, rotation, origin, 1f, SpriteEffects.None, 0f);
        }
    }
}
