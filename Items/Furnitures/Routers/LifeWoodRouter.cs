...
{
    public class LifeWoodRouter : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("生命木路由器");
        ...
        public override void SetDefaults()
        {
            ...
            base.Item.rare = 2;
            base.Item.scale = 1f;
            base.Item.createTile = base.Mod.Find<ModTile>("LifeWoodRouter").Type;
