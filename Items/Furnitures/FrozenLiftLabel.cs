...
{
    public class FrozenLiftLabel : ModItem//材料是物品名称
    {
        ...
        public override void SetDefaults()
        {
            ...
            base.Item.createTile = base.Mod.Find<ModTile>("冰冻电梯楼层显示标").Type;
        ...
        public override void AddRecipes()
        {
            ...
            modRecipe.AddIngredient(664, 2);
            modRecipe.AddTile(306);
            modRecipe.Register();
        }
    }
}
