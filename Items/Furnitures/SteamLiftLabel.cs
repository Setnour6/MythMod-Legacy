...
{
    public class SteamLiftLabel : ModItem//材料是物品名称
    {
        ...
        public override void SetDefaults()
        {
            ...
            base.Item.createTile = base.Mod.Find<ModTile>("蒸汽朋克电梯楼层显示标").Type;
        ...
        public override void AddRecipes()
        {
            ...
            modRecipe.AddIngredient(1344, 2);
            modRecipe.AddTile(307);
            modRecipe.Register();
        }
    }
}
