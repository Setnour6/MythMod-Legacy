...
{
    public class MeteorLiftLabel : ModItem//材料是物品名称
    {
        ...
        public override void SetDefaults()
        {
            ...
            base.Item.createTile = base.Mod.Find<ModTile>("陨石电梯楼层显示标").Type;
        ...
        public override void AddRecipes()
        {
            ...
            modRecipe.AddIngredient(3100, 2);
            modRecipe.AddTile(301);
            modRecipe.Register();
        }
    }
}
