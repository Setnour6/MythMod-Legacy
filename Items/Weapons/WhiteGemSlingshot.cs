...
namespace MythMod.Items.Weapons
{
    ...
    public class WhiteGemSlingshot : ModItem
	{
		...
		{
            base.DisplayName.SetDefault("钻石弹弓");
		...
		public override void SetDefaults()
		{
			...
			base.Item.UseSound = SoundID.Item5;
                 Item.shoot = base.Mod.Find<ModProjectile>("WhiteGemBead").Type;
        ...
        {//合成表1
            ...
            recipe.AddIngredient(182, 8); //要用一个泥土制作，1是数量，ItemID.DirtBlock是泥土
            recipe.AddIngredient(706, 6); //要用一个泥土制作，1是数量，ItemID.DirtBlock是泥土
