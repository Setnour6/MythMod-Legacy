...
namespace MythMod.Items.Weapons
{
    ...
    public class TurquoiseSlingshot : ModItem
	{
		// Token: 0x06001750 RID: 5968 RVA: 0x0009AF78 File Offset: 0x00099178
		public override void SetStaticDefaults()
		{
            base.DisplayName.SetDefault("绿松石弹弓");
		...
		public override void SetDefaults()
		{
			...
			base.Item.UseSound = SoundID.Item5;
                 Item.shoot = base.Mod.Find<ModProjectile>("CyanGemBead").Type;
        ...
        {//合成表1
            ...
            recipe.AddIngredient(Mod.Find<ModItem>("Turquoise").Type, 8); //要用一个泥土制作，1是数量，ItemID.DirtBlock是泥土
            recipe.AddIngredient(175, 6); //要用一个泥土制作，1是数量，ItemID.DirtBlock是泥土
