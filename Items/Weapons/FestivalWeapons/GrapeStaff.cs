...
namespace MythMod.Items.Weapons.FestivalWeapons
{
    public class GrapeStaff : ModItem
	{
		...
		{
            base.DisplayName.SetDefault("葡萄喜糖法杖");
			Item.staff[base.Item.type] = true;
            base.DisplayName.AddTranslation(GameCulture.Chinese, "葡萄喜糖法杖");
		}
        public override void SetDefaults()
		{
            ...
            base.Item.shoot = base.Mod.Find<ModProjectile>("GrapeStaff").Type;
