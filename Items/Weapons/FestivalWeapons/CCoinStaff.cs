...
namespace MythMod.Items.Weapons.FestivalWeapons
{
    ...
    public class CCoinStaff : ModItem
	{
		...
		public override void SetDefaults()
		{
            ...
            base.item.shoot = base.mod.ProjectileType("DiamondYuanbao");
			base.item.shootSpeed = 16f;
		}
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            Projectile.NewProjectile((float)Main.screenPosition.X + Main.mouseX, (float)Main.screenPosition.Y + Main.mouseY, 0, 16, base.mod.ProjectileType("DiamondYuanbao"), (int)damage, (float)knockBack, player.whoAmI, 0f, 0f);
            return false;
        }
