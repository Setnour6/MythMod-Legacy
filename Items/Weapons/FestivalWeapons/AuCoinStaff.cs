...
namespace MythMod.Items.Weapons.FestivalWeapons
{
    ...
    public class AuCoinStaff : ModItem
	{
		...
		public override void SetDefaults()
		{
            ...
            base.Item.shoot = base.Mod.Find<ModProjectile>("AuYuanbao").Type;
			base.Item.shootSpeed = 14f;
		}
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            Projectile.NewProjectile((float)Main.screenPosition.X + Main.mouseX, (float)Main.screenPosition.Y + Main.mouseY, 0, 9, base.Mod.Find<ModProjectile>("AuYuanbao").Type, (int)damage, (float)knockBack, player.whoAmI, 0f, 0f);
            return false;
        }
