...
namespace MythMod.Items.Weapons.FestivalWeapons
{
    public class AuCoinGun : ModItem
	{
		...
		public override void SetDefaults()
		{
            ...
            base.item.shoot = base.mod.ProjectileType("AuCoinBullet");
			base.item.shootSpeed = 14f;
			base.item.useAmmo = 97;
		}
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
            Projectile.NewProjectile(position.X, position.Y + Main.rand.Next(-1, 2) * 6f, speedX, speedY, base.mod.ProjectileType("AuCoinBullet"), damage, knockBack, player.whoAmI, 0f, 0f);
            return false;
		}
