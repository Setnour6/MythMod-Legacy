...
namespace MythMod.Items.Weapons.FestivalWeapons
{
    ...
    public class PtCoinStaff : ModItem
	{
		...
		public override void SetDefaults()
		{
            ...
            base.item.shoot = base.mod.ProjectileType("PtYuanbao");
			base.item.shootSpeed = 14f;
		}
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            Projectile.NewProjectile((float)Main.screenPosition.X + Main.mouseX, (float)Main.screenPosition.Y + Main.mouseY, 0, 9, base.mod.ProjectileType("PtYuanbao"), (int)damage, (float)knockBack, player.whoAmI, 0f, 0f);
            return false;
        }
