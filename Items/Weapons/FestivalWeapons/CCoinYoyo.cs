...
{
    public class CCoinYoyo : ModItem//教程是你的文件的名字
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Chinese, "钻石币球");
        }
        // Token: 0x0600462B RID: 17963 RVA: 0x0027BBA8 File Offset: 0x00279DA8
        public override void SetDefaults()
        {
            ...
            Item.shoot = Mod.Find<ModProjectile>("CCoinYoyo").Type;//发出抛掷物“yoyo”
            ...
            Item.damage = 999;
            Item.value = Item.sellPrice(0, 99, 99, 99);//价值
            Item.rare = 9;//品质
        }
    }
}
