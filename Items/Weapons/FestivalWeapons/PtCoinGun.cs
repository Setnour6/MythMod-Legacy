...
namespace MythMod.Items.Weapons.FestivalWeapons
{
    public class PtCoinGun : ModItem
	{
		...
		public override void SetDefaults()
		{
            ...
            base.Item.shoot = base.Mod.Find<ModProjectile>("PtBullet").Type;
			base.Item.shootSpeed = 14f;
			base.Item.useAmmo = 97;
		}
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
		{
            Projectile.NewProjectile(position.X, position.Y + Main.rand.Next(-1, 2) * 6f, speedX, speedY, base.Mod.Find<ModProjectile>("PtBullet").Type, damage, knockBack, player.whoAmI, 0f, 0f);
            return false;
		}
