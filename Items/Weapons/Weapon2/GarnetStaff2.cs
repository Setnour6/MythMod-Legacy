...
{
    public class GarnetStaff2 : ModItem
	{
		public override void SetStaticDefaults()
		{
            base.DisplayName.SetDefault("石榴石神杖");
			Item.staff[base.Item.type] = true;
            base.DisplayName.AddTranslation(GameCulture.Chinese, "石榴石神杖");
        }
        public override void SetDefaults()
        {
            ...
            base.Item.shoot = base.Mod.Find<ModProjectile>("GarnetStaff2").Type;
        ...
        public override void AddRecipes()
        {
            ...
            modRecipe.AddIngredient(Mod.Find<ModItem>("GarnetStaff").Type, 1);
            modRecipe.AddIngredient(Mod.Find<ModItem>("LargeGarnet").Type, 15);
