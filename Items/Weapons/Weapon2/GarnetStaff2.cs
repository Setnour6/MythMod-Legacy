...
namespace MythMod.Items.Weapons.Weapon2
{
    public class GarnetStaff2 : ModItem
	{
        ...
        public override void SetDefaults()
        {
            ...
            base.item.shoot = base.mod.ProjectileType("GarnetStaff2");
        ...
        public override void AddRecipes()
        {
            ...
            modRecipe.AddIngredient(mod.ItemType("GarnetStaff"), 1);
            modRecipe.AddIngredient(mod.ItemType("LargeGarnet"), 15);
