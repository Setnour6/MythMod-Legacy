...
{
    public class RedGemStaff2 : ModItem
	{
		public override void SetStaticDefaults()
		{
            base.DisplayName.SetDefault("红宝石神杖");
			Item.staff[base.Item.type] = true;
            base.DisplayName.AddTranslation(GameCulture.Chinese, "红宝石神杖");
        }
        public override void SetDefaults()
        {
            ...
            base.Item.shoot = base.Mod.Find<ModProjectile>("RedGemStaff2").Type;
        ...
        public override void AddRecipes()
        {
            ...
            modRecipe.AddIngredient(743, 1);
            modRecipe.AddIngredient(1526,15);
