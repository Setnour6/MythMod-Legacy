...
namespace MythMod.Items.Weapons
{
    public class SpareOfSea : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			base.Item.rare = 8;
            base.Item.shoot = base.Mod.Find<ModProjectile>("AzureOceanSpear").Type;
        ...
        {
            Projectile.NewProjectile(position.X, position.Y, speedX / 1.2f, speedY / 1.2f, Mod.Find<ModProjectile>("AzureOceanSpear2").Type, damage, knockBack, player.whoAmI);
            Vector2 perturbedSpeed = new Vector2(speedX, speedY).RotatedByRandom(MathHelper.ToRadians(0));
            speedX = perturbedSpeed.X;
            speedY = perturbedSpeed.Y;
            Projectile.NewProjectile(position.X, position.Y, speedX, speedY, Mod.Find<ModProjectile>("AzureOceanSpear").Type, damage, knockBack, player.whoAmI);
            return false;
        }
	}
}
