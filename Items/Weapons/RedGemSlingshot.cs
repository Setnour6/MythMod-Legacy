...
namespace MythMod.Items.Weapons
{
    ...
    public class RedGemSlingshot : ModItem
	{
		...
		{
            // base.DisplayName.SetDefault("红宝石弹弓");
		...
		public override void SetDefaults()
		{
			...
			base.Item.UseSound = SoundID.Item5;
                 Item.shoot = base.Mod.Find<ModProjectile>("RedGemBead").Type;
			base.Item.shootSpeed = 10.5f;
		}
        ...
        {//合成表1
            ...
            recipe.AddIngredient(178, 8); //要用一个泥土制作，1是数量，ItemID.DirtBlock是泥土
            recipe.AddIngredient(19, 6); //要用一个泥土制作，1是数量，ItemID.DirtBlock是泥土
