...
namespace MythMod.Items.Weapons.OceanWeapons
{
    public class OlivineSword : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = 14000;
            Item.scale = 1f;
            Item.shoot = Mod.Find<ModProjectile>("Olivine").Type;
            Item.shootSpeed = 15f;
        ...
        {
            Dust.NewDust(new Vector2((float)hitbox.X, (float)hitbox.Y), hitbox.Width, hitbox.Height, Mod.Find<ModDust>("Olivine").Type, 0f, 0f, 0,  default(Color), 0.6f);
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(pc.X, pc.Y, v.X, v.Y, Mod.Find<ModProjectile>("Olivine").Type, damage / 2, knockBack, player.whoAmI);
            if(num >= 4)
            {
                k = true;
            }
