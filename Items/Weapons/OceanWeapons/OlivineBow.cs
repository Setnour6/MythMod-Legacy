...
namespace MythMod.Items.Weapons.OceanWeapons
{
    public class OlivineBow : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.useAmmo = 40;
            Item.noMelee = true;
            Item.shoot = Mod.Find<ModProjectile>("OlivineArrow").Type;
            Item.shootSpeed = 13f;
            Item.reuseDelay = 14;
        }
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(position.X, position.Y, speedX, speedY, Mod.Find<ModProjectile>("OlivineArrow").Type, damage, knockBack, player.whoAmI);
            return false;
        }
