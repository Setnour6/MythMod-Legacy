...
namespace MythMod.Items.Weapons.OceanWeapons
{
    public class CoralBlade : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = 10000;
            Item.scale = 1f;
            Item.shoot = Mod.Find<ModProjectile>("鹿角珊瑚").Type;
            Item.shootSpeed = 6f;
        }
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            //顶上的不要改，不然会鬼畜
            int num3 = Projectile.NewProjectile(pc.X, pc.Y, v.X, v.Y, Mod.Find<ModProjectile>("鹿角珊瑚").Type, damage, knockBack, player.whoAmI);//195是特效代码，这里指发射物会发射到鼠标位置，34是伤害，10是击退
