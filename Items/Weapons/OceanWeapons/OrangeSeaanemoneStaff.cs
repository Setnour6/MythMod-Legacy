...
namespace MythMod.Items.Weapons.OceanWeapons
{
    ...
    public class OrangeSeaanemoneStaff : ModItem
	{
		...
		public override void SetDefaults()
		{
            ...
            base.Item.shoot = base.Mod.Find<ModProjectile>("菊花海葵").Type;
        }
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(vector.X, vector.Y, num, num2, base.Mod.Find<ModProjectile>("菊花海葵").Type, damage, knockBack, player.whoAmI, 0f, 0f);
            return false;
        }
