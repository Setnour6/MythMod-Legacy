...
namespace MythMod.Items.Weapons.OceanWeapons
{
    public class BubbleCoralStick : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = 14000;
            Item.scale = 1f;
            Item.shoot = Mod.Find<ModProjectile>("BubbleCoral").Type;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            if(Main.rand.Next(3) == 1)
            {
                ...
                Projectile.NewProjectile(pc.X, pc.Y, v.X, v.Y, Mod.Find<ModProjectile>("BubbleCoral").Type, damage, knockBack, player.whoAmI);
                if (num >= 4)
                {
                    k = true;
                }
