...
namespace MythMod.Items.Weapons.OceanWeapons
{
    public class AquamarineSword : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = 10000;
            Item.scale = 1f;
            Item.shoot = Mod.Find<ModProjectile>("OceanBlue").Type;
            Item.shootSpeed = 15f;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(pc.X, pc.Y, v.X, v.Y, Mod.Find<ModProjectile>("OceanBlue").Type, damage, knockBack, player.whoAmI);
            if(num >= 4)
            {
                k = true;
            }
