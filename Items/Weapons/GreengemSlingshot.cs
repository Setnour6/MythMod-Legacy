...
namespace MythMod.Items.Weapons
{
    ...
    public class GreengemSlingshot : ModItem
	{
		...
		{
            base.DisplayName.SetDefault("翡翠弹弓");
		...
		public override void SetDefaults()
		{
			...
			base.Item.UseSound = SoundID.Item5;
                 Item.shoot = base.Mod.Find<ModProjectile>("翡翠弹球").Type;
        ...
        {//合成表1
            ...
            recipe.AddIngredient(179, 8); //要用一个泥土制作，1是数量，ItemID.DirtBlock是泥土
            recipe.AddIngredient(705, 6); //要用一个泥土制作，1是数量，ItemID.DirtBlock是泥土
