...
{
    public class PassionFruitSword : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.scale = 1f;//��С
            Item.shoot = base.Mod.Find<ModProjectile>("PassionfruitBeam").Type;
            Item.shootSpeed = 7f;
        ...
        {
            Recipe recipe = Recipe.Create(Mod.Find<ModItem>("PassionFruitSword").Type, 1);//����һ������
            recipe.AddIngredient(null, "Passionfruit", 2); //��Ҫһ������
