...
namespace MythMod.Items.Weapons
{
    ...
    public class HotSpring : ModItem
	{
        ...
        public override void SetDefaults()
        {
            ...
            base.Item.shoot = base.Mod.Find<ModProjectile>("深海热泉").Type;
        ...
        {
            Projectile.NewProjectile(position.X, position.Y, speedX, speedY, Mod.Find<ModProjectile>("深海热泉").Type, damage, knockBack, player.whoAmI, 1f);
