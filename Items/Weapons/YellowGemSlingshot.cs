...
namespace MythMod.Items.Weapons
{
    ...
    public class YellowGemSlingshot : ModItem
	{
		...
		{
            base.DisplayName.SetDefault("黄玉弹弓");
		...
		public override void SetDefaults()
		{
			...
			base.Item.UseSound = SoundID.Item5;
                 Item.shoot = base.Mod.Find<ModProjectile>("YellowGemBead").Type;
        ...
        {//合成表1
            ...
            recipe.AddIngredient(180, 8); //要用一个泥土制作，1是数量，ItemID.DirtBlock是泥土
            recipe.AddIngredient(703, 6); //要用一个泥土制作，1是数量，ItemID.DirtBlock是泥土
