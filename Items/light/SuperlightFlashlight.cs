...
{
	public class SuperlightFlashlight : ModItem
	{
        ...
        public override void HoldItem(Player player)
        {
            ...
            {
                mplayer.SD = 13;
                Projectile.NewProjectile(player.Center.X, player.Center.Y, 0, 0f, Mod.Find<ModProjectile>("SuperlightFlashlight").Type, 0, 0f, Main.myPlayer, 0f, 0f);
            }
            mplayer.SD2 = 2;
        }
