		...
		public override void AI()
		{
	    	...
	    	if(base.NPC.localAI[0] >= 0f && base.NPC.localAI[0] <= 480f && base.NPC.localAI[0] % 60 == 0)
	    	{
				...
				if(num4 <= 60)
				{
		            ...
		            int num34 = Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, -Speed4.X, -Speed4.Y, base.Mod.Find<ModProjectile>("藤蔓球").Type, 666, 2f, Main.myPlayer, 0f, 0f);
				...
				if(num4 > 60 && num4 <= 90)
				{
                    ...
                    float num3 = (float)Math.Sqrt((double)(num * num + num2 * num2));
	    	        Vector2 Speed4 = new Vector2(base.NPC.Center.X - player.position.X, base.NPC.Center.Y - player.position.Y) / num3 * 4f;
		            int num34 = Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, -Speed4.X, -Speed4.Y, base.Mod.Find<ModProjectile>("藤蔓").Type, 777, 2f, Main.myPlayer, 0f, 0f);
				...
				if(num4 > 90 && num4 <= 100)
				{
		            ...
		            int num34 = Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, -Speed4.X, -Speed4.Y, base.Mod.Find<ModProjectile>("蕨叶").Type, 888, 2f, Main.myPlayer, 0f, 0f);
                    Main.projectile[num34].timeLeft = 480;
				}
	    	}
