		...
		public override void AI()
		{
	    	...
	    	if(base.npc.localAI[0] >= 480f && base.npc.localAI[0] <= 960f && base.npc.localAI[0] % 60 == 0)
	    	{
				...
				if(num4 <= 60)
				{
		            ...
		            int num34 = Projectile.NewProjectile(base.npc.Center.X, base.npc.Center.Y, -Speed4.X, -Speed4.Y, base.mod.ProjectileType("小火球"), 555, 2f, Main.myPlayer, 0f, 0f);
                    Main.projectile[num34].timeLeft = 300;
					int num35 = Projectile.NewProjectile(base.npc.Center.X, base.npc.Center.Y, -Speed5.X, -Speed5.Y, base.mod.ProjectileType("小火球"), 555, 2f, Main.myPlayer, 0f, 0f);
					...
					int num36 = Projectile.NewProjectile(base.npc.Center.X, base.npc.Center.Y, -Speed6.X, -Speed6.Y, base.mod.ProjectileType("小火球"), 555, 2f, Main.myPlayer, 0f, 0f);
					...
					int num37 = Projectile.NewProjectile(base.npc.Center.X, base.npc.Center.Y, -Speed7.X, -Speed7.Y, base.mod.ProjectileType("小火球"), 555, 2f, Main.myPlayer, 0f, 0f);
				...
				if(num4 > 60 && num4 <= 90)
				{
		            ...
		            int num34 = Projectile.NewProjectile(base.npc.Center.X, base.npc.Center.Y, -Speed4.X, -Speed4.Y, base.mod.ProjectileType("大火球"), 777, 2f, Main.myPlayer, 0f, 0f);
                    Main.projectile[num34].timeLeft = 300;
				}
				if(num4 > 90 && num4 <= 100)
				{
		            ...
		            int num34 = Projectile.NewProjectile(base.npc.Center.X, base.npc.Center.Y, -Speed4.X, -Speed4.Y, base.mod.ProjectileType("爆炸火球"), 888, 2f, Main.myPlayer, 0f, 0f);
