...
namespace MythMod.NPCs.LanternMoon
{
    public class AppleSlime : ModNPC
	{
		...
		public override void SetDefaults()
		{
            ...
            this.bannerItem = base.mod.ItemType("AppleSlimeBanner");
        }
        ...
        public override void AI()
        {
            ...
            if(Ene == 180)
            {
                for(int g = 0;g < 6;g++)
                {
                    ...
                    Projectile.NewProjectile(npc.Center.X + v.X, npc.Center.Y + v.Y, v.X, v.Y, base.mod.ProjectileType("AppleProj"), npc.damage, 0, Main.myPlayer, 0, 0f);
                }
                Ene = 0;
            }
        }
        public override void NPCLoot()
		{
            if(Main.rand.Next(50) == 1)
            {
                ...
                {
                    case 1:
                        type = base.mod.ItemType("AppleGun");
                        break;
                    case 2:
                        type = base.mod.ItemType("AppleStaff");
                        break;
                    case 3:
                        type = base.mod.ItemType("AppleswKnife");
                        break;
                }
