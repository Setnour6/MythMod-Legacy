...
{
    public class ChocolateSlime : ModNPC
	{
		...
		public override void SetDefaults()
		{
            ...
            this.BannerItem = base.Mod.Find<ModItem>("ChocolateSlimeBanner").Type;
        }
        ...
        public override void AI()
        {
            ...
            if (Ene == 180)
            {
                for (int g = 0; g < 6; g++)
                {
                    ...
                    Projectile.NewProjectile(NPC.Center.X + v.X, NPC.Center.Y + v.Y, v.X, v.Y, base.Mod.Find<ModProjectile>("ChocolateProj").Type, NPC.damage, 0, Main.myPlayer, 0, 0f);
                }
                Ene = 0;
            }
        }
