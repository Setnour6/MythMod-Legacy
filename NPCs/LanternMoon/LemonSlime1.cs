    ...
    public class LemonSlime1 : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (Main.netMode != 1 && base.NPC.life <= 0)
			{
				...
				NPC.NewNPC((int)vector.X, (int)vector.Y, Mod.Find<ModNPC>("LemonSlime").Type, 0, 0f, 0f, 0f, 0f, 255);
			}
		}
