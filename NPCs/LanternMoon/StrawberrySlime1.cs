...
{
    public class StrawberrySlime1 : ModNPC
	{
		public override void SetStaticDefaults()
		{
            base.DisplayName.SetDefault("草莓糖史莱姆");
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (Main.netMode != 1 && base.NPC.life <= 0)
			{
				...
				NPC.NewNPC((int)vector.X, (int)vector.Y, Mod.Find<ModNPC>("StrawberrySlime").Type, 0, 0f, 0f, 0f, 0f, 255);
			}
		}
	}
}
