...
{
    public class StrawberrySlime : ModNPC
	{
		public override void SetStaticDefaults()
		{
			// base.DisplayName.SetDefault("berry Sweat Slime");
			Main.npcFrameCount[base.NPC.type] = 2;
			base.DisplayName.AddTranslation(GameCulture.Chinese, "草莓糖史莱姆");
		}
		...
		public override void SetDefaults()
		{
            ...
            this.BannerItem = base.Mod.Find<ModItem>("StSlimeBanner").Type;
        }
        ...
        public override void AI()
        {
            ...
            if (Ene == 180)
            {
                for (int g = 0; g < 6; g++)
                {
                    ...
                    Projectile.NewProjectile(NPC.Center.X + v.X, NPC.Center.Y + v.Y, v.X, v.Y, base.Mod.Find<ModProjectile>("StrawberryProj").Type, NPC.damage, 0, Main.myPlayer, 0, 0f);
                }
                Ene = 0;
            }
        }
        public override void OnKill()
        {
            if (Main.rand.Next(50) == 1)
            {
                ...
                {
                    case 1:
                        type = base.Mod.Find<ModItem>("StrawberryGun").Type;
                        break;
                    case 2:
                        type = base.Mod.Find<ModItem>("StrawberryStaff").Type;
                        break;
                    case 3:
                        type = base.Mod.Find<ModItem>("StrawberryswKnife").Type;
                        break;
                }
