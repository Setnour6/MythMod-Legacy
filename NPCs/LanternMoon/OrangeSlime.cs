    ...
    public class OrangeSlime : ModNPC
	{
        ...
        public override void AI()
        {
            ...
            if (Ene == 180)
            {
                for (int g = 0; g < 6; g++)
                {
                    ...
                    Projectile.NewProjectile(NPC.Center.X + v.X, NPC.Center.Y + v.Y, v.X, v.Y, base.Mod.Find<ModProjectile>("OrangeProj").Type, NPC.damage, 0, Main.myPlayer, 0, 0f);
                }
                Ene = 0;
            }
        }
        public override void OnKill()
        {
            if (Main.rand.Next(50) == 1)
            {
                ...
                {
                    case 1:
                        type = base.Mod.Find<ModItem>("OrangeGun").Type;
                        break;
                    case 2:
                        type = base.Mod.Find<ModItem>("OrangeSwStaff").Type;
                        break;
                    case 3:
                        type = base.Mod.Find<ModItem>("OrangeswKnife").Type;
                        break;
                }
