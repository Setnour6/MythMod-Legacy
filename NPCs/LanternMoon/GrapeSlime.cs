...
{
    public class GrapeSlime : ModNPC
	{
		public override void SetStaticDefaults()
		{
			// base.DisplayName.SetDefault("berry Sweat Slime");
			Main.npcFrameCount[base.NPC.type] = 2;
			base.DisplayName.AddTranslation(GameCulture.Chinese, "葡萄糖史莱姆");
		}
		...
		public override void SetDefaults()
		{
            ...
            this.BannerItem = base.Mod.Find<ModItem>("GrapeslimeBanner").Type;
        }
        ...
        public override void AI()
        {
            ...
            if (Ene == 180)
            {
                for (int g = 0; g < 6; g++)
                {
                    ...
                    Projectile.NewProjectile(NPC.Center.X + v.X, NPC.Center.Y + v.Y, v.X, v.Y, base.Mod.Find<ModProjectile>("GrapeProj").Type, NPC.damage, 0, Main.myPlayer, 0, 0f);
                }
                Ene = 0;
            }
        }
        public override void OnKill()
        {
            if (Main.rand.Next(50) == 1)
            {
                ...
                {
                    case 1:
                        type = base.Mod.Find<ModItem>("GrapeGun").Type;
                        break;
                    case 2:
                        type = base.Mod.Find<ModItem>("GrapeStaff").Type;
                        break;
                    case 3:
                        type = base.Mod.Find<ModItem>("GrapeswKnife").Type;
                        break;
                }
