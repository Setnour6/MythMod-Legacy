    ...
    public class SuperWaterBomb : ModNPC
	{
        ...
        public override void OnHitPlayer(Player target, Player.HurtInfo hurtInfo)
        {
            ...
            for (int k = 0; k <= 30; k++)
            {
                ...
                int num4 = Projectile.NewProjectile(NPC.Center.X + v.X, NPC.Center.Y + v.Y, 0, 0, base.Mod.Find<ModProjectile>("熔炉烈焰").Type, 1000, 0, Main.myPlayer, Main.rand.Next(1000, 3000) / 700f, 0f);
