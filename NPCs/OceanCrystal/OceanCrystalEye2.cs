    ...
    public class OceanCrystalEye2 : ModNPC
	{
        ...
        public override void AI()
        {
            ...
            if(NPC.localAI[0] % 75 == 0)
            {
                ...
                Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, v.X, v.Y, base.Mod.Find<ModProjectile>("蔚蓝射线").Type, (int)(base.NPC.damage * 0.2f), 0.2f, Main.myPlayer, 0f, 0f);
            }
