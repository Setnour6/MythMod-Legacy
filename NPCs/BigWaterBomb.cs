    ...
    public class BigWaterBomb : ModNPC
	{
        ...
        public override void OnHitPlayer(Player target, Player.HurtInfo hurtInfo)
        {
            ...
            for (int k = 0; k <= 30; k++)
            {
                ...
                int num4 = Projectile.NewProjectile(NPC.Center.X + v.X, NPC.Center.Y + v.Y, 0, 0, base.Mod.Find<ModProjectile>("MeltingpotBlaze").Type, 200, 0, Main.myPlayer, Main.rand.Next(2500, 3200) / 4000f, 0f);
