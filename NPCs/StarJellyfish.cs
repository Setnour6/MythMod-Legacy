        ...
        public override void AI()
        {
            ...
            if (flag3 && !flag7)
            {
                if (NPC.localAI[0] % 300 == 0)
                {
                    for (int i = 0; i < 12; i++)
                    {
                        ...
                        for (int j = 0; j < 8; j++)
                        {
                            Projectile.NewProjectile(Main.player[base.NPC.target].position.X + 1000f, Main.player[base.NPC.target].position.Y + num100, -4f, 0f, base.Mod.Find<ModProjectile>("RougeRay").Type, 40, 0f, Main.myPlayer, 0f, 0f);
                            Projectile.NewProjectile(Main.player[base.NPC.target].position.X - 1000f, Main.player[base.NPC.target].position.Y + num100 - 125f, 4f, 0f, base.Mod.Find<ModProjectile>("RougeRay").Type, 40, 0f, Main.myPlayer, 0f, 0f);
                            num100 += 250;
                        }
                    }
                }
            ...
            if (flag4 && !flag7)
            {
                if (NPC.localAI[0] % 450 == 0)
                {
                    ...
                    for (int j = 0; j < 8; j++)
                    {
                        Projectile.NewProjectile(Main.player[base.NPC.target].position.X + 1000f, Main.player[base.NPC.target].position.Y + num100, -5f, 0f, base.Mod.Find<ModProjectile>("RougeRay").Type, 40, 0f, Main.myPlayer, 0f, 0f);
                        Projectile.NewProjectile(Main.player[base.NPC.target].position.X - 1000f, Main.player[base.NPC.target].position.Y + num100, 5f, 0f, base.Mod.Find<ModProjectile>("RougeRay").Type, 40, 0f, Main.myPlayer, 0f, 0f);
                        Projectile.NewProjectile(Main.player[base.NPC.target].position.X + 500f + num102, Main.player[base.NPC.target].position.Y + num100 * 0.7660254038f, -2.5f, 6.92820323f * 0.625f, base.Mod.Find<ModProjectile>("RougeRay").Type, 40, 0f, Main.myPlayer, 0f, 0f);
                        Projectile.NewProjectile(Main.player[base.NPC.target].position.X - 500f - num102, Main.player[base.NPC.target].position.Y + num100 * 0.7660254038f, 2.5f, 6.92820323f * 0.625f, base.Mod.Find<ModProjectile>("RougeRay").Type, 40, 0f, Main.myPlayer, 0f, 0f);
                        Projectile.NewProjectile(Main.player[base.NPC.target].position.X + 500f + num102, Main.player[base.NPC.target].position.Y - num100 * 0.7660254038f, -2.5f, -6.92820323f * 0.625f, base.Mod.Find<ModProjectile>("RougeRay").Type, 40, 0f, Main.myPlayer, 0f, 0f);
                        Projectile.NewProjectile(Main.player[base.NPC.target].position.X - 500f - num102, Main.player[base.NPC.target].position.Y - num100 * 0.7660254038f, 2.5f, -6.92820323f * 0.625f, base.Mod.Find<ModProjectile>("RougeRay").Type, 40, 0f, Main.myPlayer, 0f, 0f);
                        num100 += 250;
            ...
            if (flag5 && !flag7)
            {
                for (int i = 0; i < 3; i++)
                {
                    ...
                    if (base.NPC.velocity.X > -num2 && base.NPC.velocity.X < num2 && base.NPC.velocity.Y > -num2 && base.NPC.velocity.Y < num2)
                    {
                        ...
                        int num114 = base.Mod.Find<ModProjectile>("灿金射线").Type;
                        float num116 = 6f;
                ...
                if (NPC.localAI[0] % 550 == 0)
                {
                    for (int i = 0; i < 12; i++)
                    {
                        ...
                        for (int j = 0; j < 8; j++)
                        {
                            Projectile.NewProjectile(Main.player[base.NPC.target].position.X + 1000f, Main.player[base.NPC.target].position.Y + num100, -4f, 0f, base.Mod.Find<ModProjectile>("RougeRay").Type, 200, 0f, Main.myPlayer, 0f, 0f);
                            Projectile.NewProjectile(Main.player[base.NPC.target].position.X - 1000f, Main.player[base.NPC.target].position.Y + num100 - 125f, 4f, 0f, base.Mod.Find<ModProjectile>("RougeRay").Type, 200, 0f, Main.myPlayer, 0f, 0f);
                            num100 += 250;
                        }
                    }
                }
            ...
            if (flag7)
            {
                ...
                if(npclocalai100 <= num15 / 240f + 2)
                {
                    ...
                    for (int j = 0; j < 8; j++)
                    {
                        ...
                        {
                            type = Mod.Find<ModDust>("GoldGlitter").Type;
                        }
                        else
                        {
                            type = 183;
                ...
                if(npclocalai100 > num15 / 240f + 880 && npclocalai100 < num15 / 240f + 980 && npclocalai100 % 50 == 0)
                {
                    ...
                    int num16 = Projectile.NewProjectile(vector5.X, vector5.Y, 0, 0, base.Mod.Find<ModProjectile>("星渊水母幻影").Type, 48, 0f, Main.myPlayer, 0f, 0f);
                ...
                if(npclocalai100 > num15 / 240f + 880 && npclocalai100 < num15 / 240f + 2280 && npclocalai100 % 80 == 0 && !MythWorld.Myth)
                {
                    ...
                    int num17 = Projectile.NewProjectile(vector5.X, vector5.Y, 0, 0, base.Mod.Find<ModProjectile>("星渊水母幻影").Type, 48, 0f, Main.myPlayer, 0f, 0f);
                ...
                if(npclocalai100 > num15 / 240f + 2480 && npclocalai100 < num15 / 240f + 3500)
                {
                    ...
                    if (base.NPC.velocity.X > -num2 && base.NPC.velocity.X < num2 && base.NPC.velocity.Y > -num2 && base.NPC.velocity.Y < num2)
                    {
                        ...
                        for (int k = 0; k < 20; k++)
                        {
                            ...
                            if((int)k % 2 == 1)
                            {
                                Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, (float)Math.Cos(((float)i / 10f) * Math.PI) * 7 / 3 * 1.44f, (float)(0 - (float)Math.Sin(((float)i / 10f) * Math.PI) * 7) / 3 * 1.44f, base.Mod.Find<ModProjectile>("水母磷光1").Type, base.NPC.damage / 2, 0.2f, Main.myPlayer, 0f, 0f);
                            }
                            else
                            {
                                Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, (float)Math.Cos(((float)i / 10f) * Math.PI) * 7 / 3 * 1.44f, (float)(0 - (float)Math.Sin(((float)i / 10f) * Math.PI) * 7) / 3 * 1.44f, base.Mod.Find<ModProjectile>("水母磷光2").Type, base.NPC.damage / 2, 0.2f, Main.myPlayer, 0f, 0f);
                            }
                        }
                        return;
                    }
                ...
                if(npclocalai100 > num15 / 240f + 3500 && npclocalai100 < num15 / 240f + 4500 && npclocalai100 % 18 == 0)
                {
                    ...
                    Projectile.NewProjectile(vector6.X, vector6.Y, -vector8.X / 180f, -vector8.Y / 180f, base.Mod.Find<ModProjectile>("RougeRay").Type, 44, 0f, Main.myPlayer, 0f, 0f);
                    Projectile.NewProjectile(vector7.X, vector7.Y, vector8.X / 180f, vector8.Y / 180f, base.Mod.Find<ModProjectile>("RougeRay").Type, 44, 0f, Main.myPlayer, 0f, 0f);
                }
                ...
                {
			    	Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, 2.5f, 2.5f, base.Mod.Find<ModProjectile>("渊海磷光").Type, base.NPC.damage, 0.2f, Main.myPlayer, 0f, 0f);
                    Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, -2.5f, 2.5f, base.Mod.Find<ModProjectile>("渊海磷光").Type, base.NPC.damage, 0.2f, Main.myPlayer, 0f, 0f);
                    Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, 2.5f, -2.5f, base.Mod.Find<ModProjectile>("渊海磷光").Type, base.NPC.damage, 0.2f, Main.myPlayer, 0f, 0f);
                    Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, -2.5f, -2.5f, base.Mod.Find<ModProjectile>("渊海磷光").Type, base.NPC.damage, 0.2f, Main.myPlayer, 0f, 0f);
                    num18 = false;
                ...
                {
                    Vector2 vector5 = player.position + new Vector2(0, Main.rand.Next(150, 400)).RotatedBy(Math.PI * Main.rand.Next(0, 10000) / 5000f) + new Vector2(0, 140);
                    int num17 = Projectile.NewProjectile(vector5.X, vector5.Y, 0, 0, base.Mod.Find<ModProjectile>("水母电击").Type, 200, 0f, Main.myPlayer, 0f, 0f);
