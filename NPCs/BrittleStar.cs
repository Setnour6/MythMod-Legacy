...
namespace MythMod.NPCs
{
    ...
    public class BrittleStar : ModNPC
	{
        ...
        public override void AI()
		{
            ...
            int num35 = Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, vector.X, vector.Y, base.Mod.Find<ModProjectile>("海蛇尾触手").Type, 20, 0f, Main.myPlayer, 0f, 0f);
            ...
            int num36 = Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, vector2.X, vector2.Y, base.Mod.Find<ModProjectile>("海蛇尾触手").Type, 20, 0f, Main.myPlayer, 0f, 0f);
            ...
            int num37 = Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, vector3.X, vector3.Y, base.Mod.Find<ModProjectile>("海蛇尾触手").Type, 20, 0f, Main.myPlayer, 0f, 0f);
            ...
            int num38 = Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, vector4.X, vector4.Y, base.Mod.Find<ModProjectile>("海蛇尾触手").Type, 20, 0f, Main.myPlayer, 0f, 0f);
            ...
            int num39 = Projectile.NewProjectile(base.NPC.Center.X, base.NPC.Center.Y, vector5.X, vector5.Y, base.Mod.Find<ModProjectile>("海蛇尾触手").Type, 20, 0f, Main.myPlayer, 0f, 0f);
        }
