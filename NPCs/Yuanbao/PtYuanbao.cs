...
{
	public class PtYuanbao : ModNPC
	{
		private int num1 = 0;
		private int num2;
		public override void SetStaticDefaults()
		{
            // base.DisplayName.SetDefault("铂金元宝");
            base.DisplayName.AddTranslation(GameCulture.Chinese, "铂金元宝");
		}
		...
		public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (base.NPC.life <= 0)
            {
                ...
                if(mplayer.GoldTime > 0)
                {
                    if (Main.expertMode)
                    {
                        mplayer.GoldPoint += 1500;
                    }
                    else
                    {
                        mplayer.GoldPoint += 750;
                    }
                    if (mplayer.Double > 0)
                    {
                        if (Main.expertMode)
