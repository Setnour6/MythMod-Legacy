...
namespace MythMod.NPCs.Yuanbao
{
	...
	public class TimeYuanbao : ModNPC
	{
		private int num1 = 0;
		private int num2;
		...
		public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (base.NPC.life <= 0)
            {
                ...
                if(mplayer.GoldTime > 0)
                {
                    ...
                    Main.NewText(Language.GetTextValue("时间 + 5s"), new Color(84, 52, 170));
                }
            }
        }
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            vector2 -= new Vector2((float)base.Mod.GetTexture("NPCs/Yuanbao/逆时元宝Glow").Width, (float)(base.Mod.GetTexture("NPCs/Yuanbao/逆时元宝Glow").Height / Main.npcFrameCount[base.NPC.type])) * 1f / 2f;
