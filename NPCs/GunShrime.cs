	...
	public class GunShrime : ModNPC
	{
		...
		public override void AI()
		{
            ...
            if ((Main.player[num5].Center - base.NPC.Center).Length() < 200f && NPC.localAI[0] % 90 == 0)
            {
                ...
                int num3 = Projectile.NewProjectile(base.NPC.Center.X + base.NPC.direction * 16f, base.NPC.Center.Y - 4f, 0, 0, base.Mod.Find<ModProjectile>("CrackSoundWave").Type, 150, 1.2f, Main.myPlayer, 0, 0f);
