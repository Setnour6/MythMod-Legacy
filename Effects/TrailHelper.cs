...
namespace MythMod.Effects
{
    public class TrailManager
    {
        ...
        public void DoTrailCreation(Projectile projectile)
        {
            ...
            /*if (projectile.type == mod.ProjectileType("SulfurMeltingBall"))
            {
        ...
        public void TryTrailKill(Projectile projectile)
        {
            ...
            /*if (projectile.type == mod.ProjectileType("SulfurMeltingBall"))
            {
                MythMod.TrailManager.TryEndTrail(projectile, Math.Max(15f, projectile.velocity.Length() * 3f));
            }
    ...
    public class ZigZagTrailPosition : ITrailPosition
    {
        ...
        public Vector2 GetNextTrailPosition(Projectile projectile)
        {
            ...
            if (_zigType == -1) offset = projectile.velocity.RotatedBy(Math.PI / 2d);
            else if (_zigType == 1) offset = projectile.velocity.RotatedBy(Math.PI / -2d);
