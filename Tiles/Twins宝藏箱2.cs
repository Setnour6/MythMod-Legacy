...
namespace MythMod.Tiles
{
    ...
    public class Twins宝藏箱2 : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
            ...
            this.chest/* tModPorter Note: Removed. Use ContainerName.SetDefault() and TileID.Sets.BasicChest instead */ = "双子魔眼宝藏箱";
            this.ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = base.Mod.Find<ModItem>("TwinsChest2").Type;
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            int height = 16;
            Main.spriteBatch.Draw(Mod.GetTexture("Tiles/Twins宝藏箱2Glow"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.TileFrameX, tile.TileFrameY, 16, height), new Color(255,255,255,0), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
        }
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
                player.cursorItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "双子魔眼宝藏箱 ");
                if (player.cursorItemIconText == "双子魔眼宝藏箱")
				{
                    player.cursorItemIconID = base.Mod.Find<ModItem>("TwinsChest").Type;
