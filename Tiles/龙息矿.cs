...
namespace MythMod.Tiles
{
    ...
    public class 龙息矿 : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
            ...
            this.ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = base.Mod.Find<ModItem>("DragonBreathOre").Type;
			Main.tileSpelunker[(int)base.Type] = true;
			LocalizedText modTranslation = base.CreateMapEntryName(null);
			base.AddMapEntry(new Color(159 * (int)(Math.Sin(num5 / 10000f) * 0.5 + 1), 101, 196), modTranslation);
            // modTranslation.SetDefault("龙息矿");
            modTranslation.AddTranslation(GameCulture.Chinese, "龙息矿");
		}
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			num += num3;
			num2 += num4;
			Texture2D texture = base.Mod.GetTexture("Tiles/龙息矿_Glowmask");
