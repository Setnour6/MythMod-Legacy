...
namespace MythMod.Tiles
{
    ...
    public class EOW宝藏箱2 : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
            ...
            this.ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = base.Mod.Find<ModItem>("EOWChest2").Type;
		...
		{
            int num100 = j - 1;
            Projectile.NewProjectile((float)(i * 16 + 4), (float)(num100 * 16 + 10), -0.8f, 8, 95, 8, 2f, Main.myPlayer, 0f, 0f);
            Projectile.NewProjectile((float)(i * 16 + 4), (float)(num100 * 16 + 10), 0, 8.7f, 95, 8, 2f, Main.myPlayer, 0f, 0f);
            Projectile.NewProjectile((float)(i * 16 + 4), (float)(num100 * 16 + 10), 0.8f, 8, 95, 8, 2f, Main.myPlayer, 0f, 0f);
