...
namespace MythMod.Tiles.Foods
{
	public class 鱼子酱寿司 : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			// modTranslation.SetDefault("鱼子酱寿司");
			...
			this.ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = base.Mod.Find<ModItem>("FIsheggSushi").Type;
			modTranslation.AddTranslation(GameCulture.Chinese, "鱼子酱寿司");
		}
