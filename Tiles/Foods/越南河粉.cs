...
namespace MythMod.Tiles.Foods
{
	public class 越南河粉 : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			this.DustType = 13;
            this.ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = 2268;
