...
namespace MythMod.Tiles.Foods
{
	public class 芒果雪糕 : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			modTranslation.SetDefault("芒果雪糕");
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "芒果雪糕");
		}
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, Mod.Find<ModItem>("芒果雪糕").Type);
        }
    }
}
