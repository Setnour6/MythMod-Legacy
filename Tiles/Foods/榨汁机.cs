...
namespace MythMod.Tiles.Foods
{
	public class 榨汁机 : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "榨汁机");
		}
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, Mod.Find<ModItem>("榨汁机").Type);
        }
    }
}
