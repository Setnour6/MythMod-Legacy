...
namespace MythMod.Tiles.Foods
{
	public class 椰子汁 : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "椰子汁");
		}
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, base.Mod.Find<ModItem>("椰子汁").Type);
        }
    }
}
