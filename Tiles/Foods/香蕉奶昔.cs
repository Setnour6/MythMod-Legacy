...
namespace MythMod.Tiles.Foods
{
	public class 香蕉奶昔 : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			modTranslation.SetDefault("香蕉奶昔");
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "香蕉奶昔");
		}
        public override void NearbyEffects(int i, int j, bool closer)
        {
            ...
            player.AddBuff(Mod.Find<ModBuff>("冰饮I").Type, 20);
        }
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, base.Mod.Find<ModItem>("香蕉奶昔").Type);
        }
    }
}
