...
namespace MythMod.Tiles.Foods
{
	public class 香蕉雪糕 : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			// modTranslation.SetDefault("香蕉雪糕");
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "香蕉雪糕");
		}
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, Mod.Find<ModItem>("香蕉雪糕").Type);
        }
    }
}
