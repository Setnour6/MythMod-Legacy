...
namespace MythMod.Tiles.Foods
{
	public class 西瓜汁 : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "西瓜汁");
		}
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, base.Mod.Find<ModItem>("西瓜汁").Type);
        }
    }
}
