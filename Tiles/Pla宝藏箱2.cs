...
namespace MythMod.Tiles
{
    ...
    public class Pla宝藏箱2 : ModTile
	{
		...
		public override void SetDefaults()
		{
            ...
            this.chest = "世纪之花宝藏箱";
            this.chestDrop = base.mod.ItemType("PlaChest2");
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
                player.showItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "世纪之花宝藏箱 ");
                if (player.showItemIconText == "世纪之花宝藏箱")
				{
                    player.showItemIcon2 = base.mod.ItemType("PlaChest");
