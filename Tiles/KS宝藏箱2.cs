...
namespace MythMod.Tiles
{
    ...
    public class KS宝藏箱2 : ModTile
	{
		...
		public override void SetDefaults()
		{
            ...
            this.chest = "史莱姆王宝藏箱";
            this.chestDrop = base.mod.ItemType("KSChest2");
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
                player.showItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "史莱姆王宝藏箱 ");
                if (player.showItemIconText == "史莱姆王宝藏箱")
				{
                    player.showItemIcon2 = base.mod.ItemType("KSChest");
