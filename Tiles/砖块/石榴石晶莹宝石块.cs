...
namespace MythMod.Tiles.砖块
{
    public class 石榴石晶莹宝石块 : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			this.DustType = 254;
            this.ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = base.Mod.Find<ModItem>("GarnetBrick").Type;
