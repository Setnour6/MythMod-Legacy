...
namespace MythMod.Tiles
{
    ...
    public class BOC宝藏箱2 : ModTile
	{
		...
		public override void SetDefaults()
		{
            ...
            this.chest = "克苏鲁之脑宝藏箱";
            this.chestDrop = base.mod.ItemType("BOCChest2");
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
                player.showItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "克苏鲁之脑宝藏箱 ");
                if (player.showItemIconText == "克苏鲁之脑宝藏箱")
				{
                    player.showItemIcon2 = base.mod.ItemType("BOCChest");
