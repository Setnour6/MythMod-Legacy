...
namespace MythMod.Tiles
{
    ...
    public class BOC宝藏箱2 : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
            ...
            this.ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = base.Mod.Find<ModItem>("BOCChest2").Type;
