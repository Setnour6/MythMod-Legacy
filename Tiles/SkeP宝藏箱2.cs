...
namespace MythMod.Tiles
{
    ...
    public class SkeP宝藏箱2 : ModTile
	{
		...
		public override void SetDefaults()
		{
            ...
            this.chest = "机械骷髅王宝藏箱";
            this.chestDrop = base.mod.ItemType("SkePChest2");
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            int height = 16;
            Main.spriteBatch.Draw(mod.GetTexture("Tiles/SkeP宝藏箱2Glow"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.frameX, tile.frameY, 16, height), new Color(255,255,255,0), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
        }
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
                player.showItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "机械骷髅王宝藏箱 ");
                if (player.showItemIconText == "机械骷髅王宝藏箱")
				{
                    player.showItemIcon2 = base.mod.ItemType("SkePChest");
