...
namespace MythMod.Tiles
{
    public class ML宝藏箱2 : ModTile
	{
		public override void SetStaticDefaults()
		{
            ...
            this.chest/* tModPorter Note: Removed. Use ContainerName.SetDefault() and TileID.Sets.BasicChest instead */ = "月亮领主宝藏箱";
            this.ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = base.Mod.Find<ModItem>("MLChest2").Type;
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
                player.cursorItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "月亮领主宝藏箱 ");
                if (player.cursorItemIconText == "月亮领主宝藏箱")
				{
                    player.cursorItemIconID = base.Mod.Find<ModItem>("MLChest").Type;
