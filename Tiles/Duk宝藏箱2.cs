...
namespace MythMod.Tiles
{
    ...
    public class Duk宝藏箱2 : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
            ...
            // modTranslation.SetDefault("猪龙鱼公爵宝藏箱 ");
            ...
            this.chest/* tModPorter Note: Removed. Use ContainerName.SetDefault() and TileID.Sets.BasicChest instead */ = "猪龙鱼公爵宝藏箱";
            this.ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = base.Mod.Find<ModItem>("DukChest2").Type;
            modTranslation.AddTranslation(GameCulture.Chinese, "猪龙鱼公爵宝藏箱 ");
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
                player.cursorItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "猪龙鱼公爵宝藏箱 ");
                if (player.cursorItemIconText == "猪龙鱼公爵宝藏箱")
				{
                    player.cursorItemIconID = base.Mod.Find<ModItem>("DukChest").Type;
