...
namespace MythMod.Tiles
{
    ...
    public class Duk宝藏箱2 : ModTile
	{
		...
		public override void SetDefaults()
		{
            ...
            this.chest = "猪龙鱼公爵宝藏箱";
            this.chestDrop = base.mod.ItemType("DukChest2");
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
                player.showItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "猪龙鱼公爵宝藏箱 ");
                if (player.showItemIconText == "猪龙鱼公爵宝藏箱")
				{
                    player.showItemIcon2 = base.mod.ItemType("DukChest");
