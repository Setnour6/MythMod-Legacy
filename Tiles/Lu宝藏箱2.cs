...
namespace MythMod.Tiles
{
    public class Lu宝藏箱2 : ModTile
	{
		public override void SetDefaults()
		{
            ...
            this.chest = "拜月教邪教徒宝藏箱";
            this.chestDrop = base.mod.ItemType("LuChest2");
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
                player.showItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "拜月教邪教徒宝藏箱 ");
                if (player.showItemIconText == "拜月教邪教徒宝藏箱")
				{
                    player.showItemIcon2 = base.mod.ItemType("LuChest");
