...
namespace MythMod.Tiles
{
    public class Lu宝藏箱2 : ModTile
	{
		public override void SetStaticDefaults()
		{
            ...
            // modTranslation.SetDefault("拜月教邪教徒宝藏箱 ");
            ...
            this.chest/* tModPorter Note: Removed. Use ContainerName.SetDefault() and TileID.Sets.BasicChest instead */ = "拜月教邪教徒宝藏箱";
            this.ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = base.Mod.Find<ModItem>("LuChest2").Type;
            modTranslation.AddTranslation(GameCulture.Chinese, "拜月教邪教徒宝藏箱 ");
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			if (num3 < 0)
			{
				player.cursorItemIconText = Lang.chestType[0].Value;//213456
			}
			else
			{
                player.cursorItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "拜月教邪教徒宝藏箱 ");
                if (player.cursorItemIconText == "拜月教邪教徒宝藏箱")
				{
                    player.cursorItemIconID = base.Mod.Find<ModItem>("LuChest").Type;
