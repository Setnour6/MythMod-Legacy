...
{
	public class ColdWoodRouter : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			// modTranslation.SetDefault("针叶木路由器");
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "针叶木路由器");
		}
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            Item.NewItem(i * 16, j * 16, 16, 32, Mod.Find<ModItem>("ColdWoodRouter").Type, 1, false, 0, false, false);
        }
