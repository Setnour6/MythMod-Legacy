...
{
	public class BlackWoodRouter : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			modTranslation.SetDefault("乌木路由器");
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "乌木路由器");
		}
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            Item.NewItem(i * 16, j * 16, 16, 32, Mod.Find<ModItem>("乌木路由器").Type, 1, false, 0, false, false);
        }
