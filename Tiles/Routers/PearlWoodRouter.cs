...
{
	public class PearlWoodRouter : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			// modTranslation.SetDefault("珍珠木路由器");
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "珍珠木路由器");
		}
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            Item.NewItem(i * 16, j * 16, 16, 32, Mod.Find<ModItem>("PearlWoodRouter").Type, 1, false, 0, false, false);
        }
