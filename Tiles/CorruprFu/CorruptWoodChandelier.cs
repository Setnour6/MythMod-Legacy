...
{
	public class CorruptWoodChandelier : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "朽木吊灯");
		}
		...
		{
			Item.NewItem(i * 16, j * 16, 48, 48, base.Mod.Find<ModItem>("CorruptWoodChandelier").Type, 1, false, 0, false, false);
		}
