...
{
	public class CorruptWoodLamp : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "朽木灯");
		}
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 32, base.Mod.Find<ModItem>("CorruptWoodLamp").Type, 1, false, 0, false, false);
		}
