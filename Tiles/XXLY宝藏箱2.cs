...
namespace MythMod.Tiles
{
    ...
    public class XXLY宝藏箱2 : ModTile
	{
		...
		public override void SetDefaults()
		{
            ...
            this.chest = "鲜血獠牙宝藏箱";
            this.chestDrop = base.mod.ItemType("XXLYChest2");
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
                player.showItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "鲜血獠牙宝藏箱 ");
                if (player.showItemIconText == "鲜血獠牙宝藏箱")
				{
                    player.showItemIcon2 = base.mod.ItemType("XXLYChest");
