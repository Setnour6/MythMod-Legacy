...
namespace MythMod.Tiles.电梯
{
	...
	public class 天域电梯楼层显示标 : ModTile
	{
        ...
        public override void SetStaticDefaults()
		{
			...
			// modTranslation.SetDefault("天域电梯楼层显示标");
			base.AddMapEntry(new Color(60, 60, 60), modTranslation);
			modTranslation.AddTranslation(GameCulture.Chinese, "天域电梯楼层显示标");
		}
		...
		{
		    Item.NewItem(i * 16, j * 16, 16, 32, Mod.Find<ModItem>("AirLiftLabel").Type, 1, false, 0, false, false);
		}
    }
}
