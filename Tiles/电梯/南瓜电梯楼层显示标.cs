...
namespace MythMod.Tiles.电梯
{
	...
	public class 南瓜电梯楼层显示标 : ModTile
	{
        ...
        public override void SetStaticDefaults()
		{
			...
			modTranslation.SetDefault("南瓜电梯楼层显示标");
			base.AddMapEntry(new Color(60, 60, 60), modTranslation);
			modTranslation.AddTranslation(GameCulture.Chinese, "南瓜电梯楼层显示标");
		}
		...
		{
		    Item.NewItem(i * 16, j * 16, 16, 32, Mod.Find<ModItem>("PumpkinLiftLabel").Type, 1, false, 0, false, false);
		}
    }
}
