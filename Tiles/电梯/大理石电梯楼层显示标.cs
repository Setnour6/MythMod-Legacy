...
{
	public class 大理石电梯楼层显示标 : ModTile
	{
        public override void SetStaticDefaults()
		{
			...
			modTranslation.SetDefault("大理石电梯楼层显示标");
			base.AddMapEntry(new Color(60, 60, 60), modTranslation);
			modTranslation.AddTranslation(GameCulture.Chinese, "大理石电梯楼层显示标");
		}
		...
		{
		    Item.NewItem(i * 16, j * 16, 16, 32, Mod.Find<ModItem>("MarbleLiftLabel").Type, 1, false, 0, false, false);
		}
    }
}
