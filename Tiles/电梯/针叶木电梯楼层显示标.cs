...
namespace MythMod.Tiles.电梯
{
	...
	public class 针叶木电梯楼层显示标 : ModTile
	{
        ...
        public override void SetStaticDefaults()
		{
			...
			// modTranslation.SetDefault("针叶木电梯楼层显示标");
			base.AddMapEntry(new Color(60, 60, 60), modTranslation);
			modTranslation.AddTranslation(GameCulture.Chinese, "针叶木电梯楼层显示标");
		}
		...
		{
		    Item.NewItem(i * 16, j * 16, 16, 32, Mod.Find<ModItem>("ColdWoodLiftLabel").Type, 1, false, 0, false, false);
		}
    }
}
