...
namespace MythMod.Tiles
{
    ...
    public class Ske宝藏箱2 : ModTile
	{
		...
		public override void SetDefaults()
		{
            ...
            this.chest = "骷髅王宝藏箱";
            this.chestDrop = base.mod.ItemType("SkeChest2");
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
                player.showItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "骷髅王宝藏箱 ");
                if (player.showItemIconText == "骷髅王宝藏箱")
				{
                    player.showItemIcon2 = base.mod.ItemType("SkeChest");
