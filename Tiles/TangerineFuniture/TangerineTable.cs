...
{
	public class TangerineTable : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			// modTranslation.SetDefault("年桔木桌");
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 32, base.Mod.Find<ModItem>("TangerineTable").Type, 1, false, 0, false, false);
		}
	}
}
