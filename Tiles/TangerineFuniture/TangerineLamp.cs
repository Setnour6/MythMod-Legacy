...
{
	public class TangerineLamp : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			// modTranslation.SetDefault("年桔木灯");
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "年桔木灯");
		}
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 32, base.Mod.Find<ModItem>("TangerineLamp").Type, 1, false, 0, false, false);
		}
