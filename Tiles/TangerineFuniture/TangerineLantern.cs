...
{
	public class TangerineLantern : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			modTranslation.SetDefault("年桔木灯笼");
			...
			modTranslation.AddTranslation(GameCulture.Chinese, "年桔木灯笼");
		}
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 32, base.Mod.Find<ModItem>("TangerineLantern").Type, 1, false, 0, false, false);
		}
