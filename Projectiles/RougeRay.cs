...
namespace MythMod.Projectiles
{
    ...
    public class RougeRay : ModProjectile
	{
		...
		public override Color? GetAlpha(Color lightColor)
		{
            ...
            {
                return new Color?(new Color(100, 255, 255, 0));
            }
            else
            {
                return new Color?(new Color(projectile.timeLeft / 90, projectile.timeLeft / 90, projectile.timeLeft / 90, 0));
            }
		}
