	...
	public class GreenFireYoyo : ModProjectile
	{
		...
		public override void AI()
		{
            ...
            if (X % 3 == 0)
            {
                ...
                int num34 = Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, V.X, V.Y, base.Mod.Find<ModProjectile>("FireworkGreen3").Type, base.Projectile.damage, 0.2f, Main.myPlayer, 0f, 0f);
            }
        }
