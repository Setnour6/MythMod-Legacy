...
namespace MythMod.Projectiles
{
    public class WaveBallMini : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int j = 0; j < 30; j++)
            {
                int num2 = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y), 0, 0, Mod.Find<ModDust>("Wave").Type, 0f, 0f, 100, default(Color), 1.5f);
            ...
            for (int j = 0; j < 30; j++)
            {
                int num2 = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y), 0, 0, Mod.Find<ModDust>("Wave2").Type, 0f, 0f, 100, default(Color), 4.5f);
            ...
            for (int j = 0; j < 20; j++)
            {
                int num2 = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y), 0, 0, Mod.Find<ModDust>("Wave").Type, 0f, 0f, 100, default(Color), 0.7f);
            ...
            for (int j = 0; j < 20; j++)
            {
                int num2 = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y), 0, 0, Mod.Find<ModDust>("Wave2").Type, 0f, 0f, 100, default(Color), 2.1f);
            ...
            for (int j = 0; j < 10; j++)
            {
                int num2 = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y), 0, 0, Mod.Find<ModDust>("Wave").Type, 0f, 0f, 100, default(Color), 0.4f);
            ...
            for (int j = 0; j < 10; j++)
            {
                int num2 = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y), 0, 0, Mod.Find<ModDust>("Wave2").Type, 0f, 0f, 100, default(Color), 1.2f);
