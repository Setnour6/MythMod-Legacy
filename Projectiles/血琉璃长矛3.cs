...
namespace MythMod.Projectiles
{
    ...
    public class 血琉璃长矛3 : ModProjectile
	{
		...
		public override void AI()
		{
            ...
            {
                Projectile.NewProjectile(projectile.Center.X,projectile.Center.Y, Main.rand.Next(-100,100) / 40f, Main.rand.Next(-100,100) / 40f, base.mod.ProjectileType("血琉璃长矛火花"), (int)((double)base.projectile.damage * 0.4f), base.projectile.knockBack, base.projectile.owner, 0f, 0f);
            }
		}
