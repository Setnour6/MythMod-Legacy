...
namespace MythMod.Projectiles
{
    ...
    public class 血琉璃长矛3 : ModProjectile
	{
		...
		public override void AI()
		{
            ...
            if(Projectile.timeLeft % 9 == X)
            {
                Projectile.NewProjectile(Projectile.Center.X,Projectile.Center.Y, Main.rand.Next(-100,100) / 40f, Main.rand.Next(-100,100) / 40f, base.Mod.Find<ModProjectile>("血琉璃长矛火花").Type, (int)((double)base.Projectile.damage * 0.4f), base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
            }
		}
