...
namespace MythMod.Projectiles
{
    public class AzureOceanSpear2 : ModProjectile
	{
		...
		public override void AI()
		{
            ...
            {
                int num1 = Dust.NewDust(new Vector2((float)base.Projectile.position.X + 18f, (float)base.Projectile.position.Y + 15f), 0, 0, Mod.Find<ModDust>("Wave").Type, base.Projectile.velocity.X * 0.5f, base.Projectile.velocity.Y * 0.5f, 150, Color.White, 1f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int j = 0; j < 90; j++)
            {
                int num2 = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y), 0, 0, Mod.Find<ModDust>("Wave").Type, 0f, 0f, 100, default(Color), 0.8f);
            ...
            for (int j = 0; j < 90; j++)
            {
                int num2 = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y), 0, 0, Mod.Find<ModDust>("Wave2").Type, 0f, 0f, 100, default(Color), 2.4f);
