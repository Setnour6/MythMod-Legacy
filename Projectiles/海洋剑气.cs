    ...
    public class 海洋剑气 : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (base.Projectile.owner == Main.myPlayer)
            {
                ...
                if (num11 == 1)
                {
                    int num10 = Projectile.NewProjectile(num4, num5, num6, num7, base.Mod.Find<ModProjectile>("海洋剑气2").Type, base.Projectile.damage, 5f, base.Projectile.owner, 0f, 0f);
                ...
                if (num11 == 4)
                {
                    int num10 = Projectile.NewProjectile(num4, num5, num6, num7, base.Mod.Find<ModProjectile>("海浪球").Type, base.Projectile.damage, 5f, base.Projectile.owner, 0f, 0f);
                    Main.projectile[num10].ai[1] = base.Projectile.position.Y;
                }
            }
            }
