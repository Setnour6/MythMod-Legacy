...
namespace MythMod.Projectiles
{
    ...
    public class 圣明光环 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Lighting.AddLight(base.Projectile.Center, (float)(255 - base.Projectile.alpha) * 0.75f / 255f, (float)(255 - base.Projectile.alpha) * 0.75f / 255f, (float)(255 - base.Projectile.alpha) * 0f / 255f);
		}
