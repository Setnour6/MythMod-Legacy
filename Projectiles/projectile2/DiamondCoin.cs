...
namespace MythMod.Projectiles.projectile2
{
	...
	public class DiamondCoin : ModProjectile
	{
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            for (int i = 0; i < 3; i++)
            {
                int num = Dust.NewDust(new Vector2(base.Projectile.position.X, base.Projectile.position.Y), base.Projectile.width, base.Projectile.height, 13, 0, 0, 0, default(Color), 1);
            }
		...
		{
            SoundEngine.PlaySound(SoundID.Item27.WithVolumeScale(0.5f), new Vector2(base.Projectile.position.X, base.Projectile.position.Y));
        }
