...
namespace MythMod.Projectiles.projectile2
{
    ...
    public class RedLED : ModProjectile
	{
        ...
        {
            if ((int)(Main.time / 5f) % 12 >= 0 && (int)(Main.time / 5f) % 12 < 3)
            {
        ...
        public override void Kill(int timeLeft)
        {
            for(int i = 0; i < 25; i++)
            {
                int num3 = Dust.NewDust(base.Projectile.Center - base.Projectile.velocity * 4f - new Vector2(4, 4), 0, 0, 90, 0, 0, 0, default(Color), 1f);
            }
        }
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if ((int)(Main.time / 5f) % 12 >= 0 && (int)(Main.time / 5f) % 12 < 3)
            {
                spriteBatch.Draw(base.Mod.GetTexture("Projectiles/烟花火球红light"), base.Projectile.Center - Main.screenPosition, null, new Color(0.1f, 0.1f, 0.1f, 0), base.Projectile.rotation, new Vector2(56f, 56f), 1, SpriteEffects.None, 0f);
            }
            return false;
        }
    }
