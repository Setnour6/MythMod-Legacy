    ...
    public class FireBall2 : ModProjectile
	{
        ...
        public override void AI()
		{
            ...
            if(projectile.timeLeft < 3592)
            {
                ...
                {
                    int r0 = Dust.NewDust(new Vector2(base.projectile.Center.X, base.projectile.Center.Y) - new Vector2(4, 4) + new Vector2(0, Main.rand.NextFloat(0,36f)).RotatedByRandom(MathHelper.TwoPi), 0, 0, mod.DustType("Flame3"), 0, 0, 0, default(Color), 7f);
