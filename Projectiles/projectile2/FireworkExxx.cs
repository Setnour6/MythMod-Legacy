...
namespace MythMod.Projectiles.projectile2
{
    ...
    public class FireworkExxx : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, 0, 0, base.mod.ProjectileType("烟花滞留"), 0, 0, base.projectile.owner, 0f, 0f);
            Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, 0, 0, base.mod.ProjectileType("烟花爆炸"), 0, 0, base.projectile.owner, 0f, 0f);
