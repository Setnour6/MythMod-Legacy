...
namespace MythMod.Projectiles.projectile2
{
    ...
    public class GreenGemBead : ModProjectile
	{
		...
		{
            // base.DisplayName.SetDefault("翡翠弹球");
		}
		...
		{
            int r = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y) + base.Projectile.velocity * 1.5f + new Vector2(-9, -4), 0, 0, 89, 0, 0, 0, default(Color), 1f);
