...
namespace MythMod.Projectiles.projectile2
{
    ...
    public class AuYuanbao : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Gore.NewGore(base.Projectile.position, base.Projectile.velocity * scaleFactor, base.Mod.GetGoreSlot("Gores/金元宝碎块1"), 1f);
            Gore.NewGore(base.Projectile.position, base.Projectile.velocity * scaleFactor, base.Mod.GetGoreSlot("Gores/金元宝碎块2"), 1f);
            Gore.NewGore(base.Projectile.position, base.Projectile.velocity * scaleFactor, base.Mod.GetGoreSlot("Gores/金元宝碎块2"), 1f);
            Gore.NewGore(base.Projectile.position, base.Projectile.velocity * scaleFactor, base.Mod.GetGoreSlot("Gores/金元宝碎块3"), 1f);
        }
