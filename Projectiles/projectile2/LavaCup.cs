...
namespace MythMod.Projectiles.projectile2
{
    public class LavaCup : ModProjectile
    {
        ...
        {
            bool flag2 = base.Projectile.type == base.Mod.Find<ModProjectile>("LavaCup").Type;
            ...
            if (!player.HasBuff(Mod.Find<ModBuff>("LavaCup").Type))
            {
                ...
                {
                    if (Main.projectile[i].type == Mod.Find<ModProjectile>("LavaCup").Type)
                    {
            ...
            if (flag)
            {
                ...
                {
                    int i = Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, 0 + num16.X, 2 + num16.Y, base.Mod.Find<ModProjectile>("火山溅射").Type, base.Projectile.damage * 4, base.Projectile.knockBack, Main.myPlayer, 0f, 0f);
