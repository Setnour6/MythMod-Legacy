...
namespace MythMod.Projectiles.projectile2
{
    ...
    public class PtYuanbao : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Gore.NewGore(base.projectile.position, base.projectile.velocity * scaleFactor, base.mod.GetGoreSlot("Gores/铂金元宝碎块1"), 1f);
            Gore.NewGore(base.projectile.position, base.projectile.velocity * scaleFactor, base.mod.GetGoreSlot("Gores/铂金元宝碎块2"), 1f);
            Gore.NewGore(base.projectile.position, base.projectile.velocity * scaleFactor, base.mod.GetGoreSlot("Gores/铂金元宝碎块2"), 1f);
            Gore.NewGore(base.projectile.position, base.projectile.velocity * scaleFactor, base.mod.GetGoreSlot("Gores/铂金元宝碎块3"), 1f);
        }
