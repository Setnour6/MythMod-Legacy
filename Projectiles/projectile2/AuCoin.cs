...
namespace MythMod.Projectiles.projectile2
{
	...
	public class AuCoin : ModProjectile
	{
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            for (int i = 0; i < 3; i++)
            {
                int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, 10, 0, 0, 0, default(Color), 1);
            }
