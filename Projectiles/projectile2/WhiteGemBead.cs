...
namespace MythMod.Projectiles.projectile2
{
    ...
    public class WhiteGemBead : ModProjectile
	{
		// Token: 0x0600245F RID: 9311 RVA: 0x0000C7BC File Offset: 0x0000A9BC
		public override void SetStaticDefaults()
		{
            base.DisplayName.SetDefault("钻石弹球");
		}
		...
		{
            int r = Dust.NewDust(new Vector2(base.projectile.Center.X, base.projectile.Center.Y) + base.projectile.velocity * 1.5f + new Vector2(-9, -4), 0, 0, 91, 0, 0, 0, default(Color), 1f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 30; i++)
            {
                int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, 91, 0f, 0f, 100, default(Color), 1.2f);
