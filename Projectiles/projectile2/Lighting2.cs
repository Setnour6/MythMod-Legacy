    ...
    public class Lighting2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if(Main.rand.Next(250) == 1)
            {
                ...
                int num40 = Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, v.X, v.Y, base.Mod.Find<ModProjectile>("Lighting2").Type, 35, 2f, Main.myPlayer, 0f, 0);
