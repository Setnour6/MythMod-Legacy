    ...
    public class AzureRay2 : ModProjectile
	{
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            else
            {
                ...
                int num2 = Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, 0, 0, base.Mod.Find<ModProjectile>("AzureRayBump").Type, base.Projectile.damage, base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
