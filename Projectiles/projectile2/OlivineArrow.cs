...
namespace MythMod.Projectiles.projectile2
{
    public class OlivineArrow : ModProjectile
	{
        ...
        {
            int num3 = Dust.NewDust(base.Projectile.Center - base.Projectile.velocity - new Vector2(2, 2), 0, 0, Mod.Find<ModDust>("Olivine").Type, 0, 0, 0, default(Color), 1.6f);
        ...
        public override void Kill(int timeLeft)
        {
            for (int k = 0; k <= 15; k++)
            {
                ...
                int num4 = Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, (float)((float)l * Math.Cos((float)a)) * 0.16f, (float)((float)l * Math.Sin((float)a)) * 0.16f, base.Mod.Find<ModProjectile>("OlivineShoot").Type, base.Projectile.damage, base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
