		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			if (base.projectile.getRect().Intersects(value))
			{
				...
				for (int i = 1; i < projectile.oldPos.Length + u; i++)
				{
                    ...
                    Main.spriteBatch.Draw(Main.projectileTexture[base.projectile.type], drawPos, null, color2, base.projectile.rotation, new Vector2(num3, (float)(base.projectile.height / 2 + num)), base.projectile.scale, effects, 0f);
				}
			}
            return true;
        }
