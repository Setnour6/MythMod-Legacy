...
{
    //135596
    public class FireworkPink2 : ModProjectile
    {
        //4444444
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("烟花火球粉红2");
        }
        //7359668
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(base.Projectile.Center, (float)(255 - base.Projectile.alpha) * 0.894f / 255f * Projectile.scale, (float)(255 - base.Projectile.alpha) * 0.066667f / 255f * Projectile.scale, (float)(255 - base.Projectile.alpha) * 0.341f / 255f *Projectile.scale);
        }
        //14141414141414
