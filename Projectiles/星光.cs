...
namespace MythMod.Projectiles
{
    ...
    public class 星光 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				int ID = Dust.NewDust(projectile.Center, 0, 0, 159, 0, 0, 0, default(Color), 1.4f * projectile.timeLeft / 100);/*粉尘效果不用管*/
		    	Main.dust[ID].noGravity = true;
		    	Main.dust[ID].velocity *= 0;
			}
			if (projectile.timeLeft < 100)
