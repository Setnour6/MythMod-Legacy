...
namespace MythMod.Projectiles
{
    ...
    public class 紫点海葵 : ModProjectile
	{
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            spriteBatch.Draw(base.Mod.GetTexture("Projectiles/紫点海葵Glow"), base.Projectile.Center - Main.screenPosition, new Rectangle?(new Rectangle(0, y, texture2D.Width, num17)), new Color(255,255,255,base.Projectile.alpha), base.Projectile.rotation, origin, base.Projectile.scale, SpriteEffects.None, 0f);
        }
        ...
        public override void AI()
		{
            if (base.Projectile.timeLeft == 299)
            {
                ...
                for (int i = 0; i < num; i++)
                {
                    ...
                    int num2 = Dust.NewDust(vector + vector2, 0, 0, 16, vector2.X * 0.3f, vector2.Y * 0.3f, 100, default(Color), 1.4f);
                    Main.dust[num2].noGravity = true;
                }
            }
            if (base.Projectile.timeLeft % 30 == 0 && !A)
            {
                Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y - 5f, Main.rand.Next(-100, 100) / 150f, -5f, base.Mod.Find<ModProjectile>("紫点海葵粒子").Type, base.Projectile.damage, base.Projectile.knockBack, Main.myPlayer, 0f, 0f);
            }
			...
			Lighting.AddLight(base.Projectile.Center, (float)(255 - base.Projectile.alpha) * 0.4f / 255f, (float)(255 - base.Projectile.alpha) * 0.4f / 255f, (float)(255 - base.Projectile.alpha) * 0.9f / 255f);
            if(A)
            {
