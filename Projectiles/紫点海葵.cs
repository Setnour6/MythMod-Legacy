...
namespace MythMod.Projectiles
{
    ...
    public class 紫点海葵 : ModProjectile
	{
        ...
        public override void AI()
		{
            ...
            {
                Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y - 5f, Main.rand.Next(-100, 100) / 150f, -5f, base.mod.ProjectileType("紫点海葵粒子"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
            }
