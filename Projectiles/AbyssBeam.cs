...
namespace MythMod.Projectiles
{
    public class AbyssBeam : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				int num = Dust.NewDust((base.Projectile.Center - base.Projectile.velocity * 4f - new Vector2(4, 4)), 0, 0, Mod.Find<ModDust>("Flame").Type, base.Projectile.velocity.X * 0.5f, base.Projectile.velocity.Y * 0.5f, 0, Color.White, 1.3f);
        ...
        public override void Kill(int timeLeft)
        {
            for (int i = 0; i < 22; i++)
            {
                int num = Dust.NewDust(base.Projectile.position, base.Projectile.width, base.Projectile.height, Mod.Find<ModDust>("Flame").Type, base.Projectile.velocity.X * 0f, base.Projectile.velocity.Y * 0f, 0, Color.White, 1.5f);
                Main.dust[num].velocity = new Vector2(0,Main.rand.NextFloat(0f,6f)).RotatedByRandom(MathHelper.TwoPi);
                Main.dust[num].noGravity = true;
            }
            Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, 2f, 2f, base.Mod.Find<ModProjectile>("AbyssBomb").Type, Projectile.damage, 0, Main.myPlayer, 0f, 0f);
        }
