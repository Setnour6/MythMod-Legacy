	...
	public class PtCoinYoyo : ModProjectile
	{
		...
		public override void AI()
		{
            ...
            if ((int)(Main.time / 5f) % 15 == 0)
            {
                ...
                Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, v.X, v.Y, base.Mod.Find<ModProjectile>("PtCoin").Type, (int)((double)base.Projectile.damage * 0.6f), base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
            }
        }
