        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (base.projectile.owner == Main.myPlayer)
            {
                for (int i = 0; i < 10; i++)
                {
                    ...
                    Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, (float)(Math.Sin(num4) * 6.0), (float)(Math.Cos(num4) * 6.0), base.mod.ProjectileType("炼狱火尘"), 608, base.projectile.knockBack, base.projectile.owner, 0f, 0f);
                }
            }
            for (int j = 0; j <= 10; j++)
            {
