		...
		public override void AI()
		{
            ...
            for (int j = 0; j < 200; j++)
            {
                if (Ix[j] != -1)
                {
                    ...
                    {
                        Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, 0, 0, base.Mod.Find<ModProjectile>("EvilLightingbolt3").Type, base.Projectile.damage * 4, base.Projectile.knockBack, base.Projectile.owner, Main.npc[Ix[j]].Center.X, Main.npc[Ix[j]].Center.Y);
