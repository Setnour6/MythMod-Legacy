...
{
    public class WhiteFlashlight : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            base.DisplayName.SetDefault("白手电筒");
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                {
                    Lighting.AddLight(base.Projectile.Center + step * Projectile.velocity, (float)(255 - base.Projectile.alpha) * 1.2f / 255f * (40 - (float)step) / 40f * Lig, (float)(255 - base.Projectile.alpha) * 1.2f / 255f * (40 - (float)step) / 40f * Lig, (float)(255 - base.Projectile.alpha) * 1.2f / 255f * (40 - (float)step) / 40f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
