...
{
    public class RedFlashlight : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            // base.DisplayName.SetDefault("红手电筒");
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                {
                    Lighting.AddLight(base.Projectile.Center + step * Projectile.velocity, (float)(255 - base.Projectile.alpha) * 3.4f / 255f * (36 - (float)step) / 36f * Lig, (float)(255 - base.Projectile.alpha) * 0f / 255f * (36 - (float)step) / 36f * Lig, (float)(255 - base.Projectile.alpha) * 0f / 255f * (36 - (float)step) / 36f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
