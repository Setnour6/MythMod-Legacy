...
{
    public class PurpleFlashlight : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            // base.DisplayName.SetDefault("紫手电筒");
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                {
                    Lighting.AddLight(base.Projectile.Center + step * Projectile.velocity, (float)(255 - base.Projectile.alpha) * 1.1f / 255f * (30 - (float)step) / 30f * Lig, (float)(255 - base.Projectile.alpha) * 0f / 255f * (30 - (float)step) / 30f * Lig, (float)(255 - base.Projectile.alpha) * 1.5f / 255f * (30 - (float)step) / 30f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
