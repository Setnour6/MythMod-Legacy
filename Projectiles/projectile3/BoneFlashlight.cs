...
{
    public class BoneFlashlight : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            // base.DisplayName.SetDefault("骨头手电筒");
        ...
        public override void AI()
        {
            ...
            if(mplayer.SD2 > 0 && mplayer.SD == 14)
            {
                base.Projectile.timeLeft = 2;
            }
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                {
                     Lighting.AddLight(base.Projectile.Center + step * Projectile.velocity, (float)(255 - base.Projectile.alpha) * 0.52f / 255f * (25 - (float)step) / 7f * Lig, (float)(255 - base.Projectile.alpha) * 0.6f / 255f * (15 - (float)step) / 7f * Lig, (float)(255 - base.Projectile.alpha) * 0.95f / 255f * (30 - (float)step) / 30f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
