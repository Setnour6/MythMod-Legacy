...
{
    public class CyanFlashlight : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            // base.DisplayName.SetDefault("蓝绿手电筒");
        ...
        public override void AI()
        {
            ...
            if(mplayer.SD2 > 0 && mplayer.SD == 20)
            {
                base.Projectile.timeLeft = 2;
            }
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                {
                    Lighting.AddLight(base.Projectile.Center + step * Projectile.velocity, (float)(255 - base.Projectile.alpha) * 0f / 255f * (40 - (float)step) / 40f * Lig, (float)(255 - base.Projectile.alpha) * 1.83f / 255f * (40 - (float)step) / 40f * Lig, (float)(255 - base.Projectile.alpha) * 1.8f / 255f * (40 - (float)step) / 40f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
