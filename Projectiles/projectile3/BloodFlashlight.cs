...
{
    public class BloodFlashlight : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if(mplayer.SD2 > 0 && mplayer.SD == 12)
            {
                base.Projectile.timeLeft = 2;
            }
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                {
                    Lighting.AddLight(base.Projectile.Center + step * Projectile.velocity, (float)(255 - base.Projectile.alpha) * 1.4f / 255f * (30 - (float)step) / 30f * Lig, (float)(255 - base.Projectile.alpha) * 1.4f / 255f * (15 - (float)step) / 30f * Lig, (float)(255 - base.Projectile.alpha) * 0f / 255f * (30 - (float)step) / 30f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
