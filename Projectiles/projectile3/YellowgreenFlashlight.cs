...
{
    public class YellowgreenFlashlight : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            // base.DisplayName.SetDefault("黄绿手电筒");
        ...
        public override void AI()
        {
            ...
            if(mplayer.SD2 > 0 && mplayer.SD == 21)
            {
                base.Projectile.timeLeft = 2;
            }
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                {
                     Lighting.AddLight(base.Projectile.Center + step * Projectile.velocity, (float)(255 - base.Projectile.alpha) * 0.8f / 255f * (20 - (float)step) / 4f * Lig, (float)(255 - base.Projectile.alpha) * 1f / 255f * (40 - (float)step) / 7f * Lig, (float)(255 - base.Projectile.alpha) * 0.3f / 255f * (20 - (float)step) / 7f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
