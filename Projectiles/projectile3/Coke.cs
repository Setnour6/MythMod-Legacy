...
{
    public class Coke : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 60; i++)
            {
                ...
                int num = Dust.NewDust(new Vector2(base.Projectile.position.X, base.Projectile.position.Y), base.Projectile.width, base.Projectile.height, 124, v.X, v.Y, 100, default(Color), 2f);
            ...
            for (int i = 0; i < 60; i++)
            {
                int num = Dust.NewDust(new Vector2(base.Projectile.position.X, base.Projectile.position.Y), base.Projectile.width, base.Projectile.height, 148, 0f, 0f, 100, default(Color), 1f);
                Main.dust[num].noGravity = true;
            }
        }
