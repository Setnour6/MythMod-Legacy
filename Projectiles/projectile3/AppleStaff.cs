        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            if(projectile.ai[0] == 1)
            {
                ...
                for(int i = 0;i < 8;i++)
                {
                    ...
                    int y = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, v2.X, v2.Y, base.mod.ProjectileType("AppleStaff"), (int)(projectile.damage * 0.8f), 0, player.whoAmI, -1, 0f);
                }
            }
        }
