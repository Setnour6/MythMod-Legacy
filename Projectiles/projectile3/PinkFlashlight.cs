...
{
    public class PinkFlashlight : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            base.DisplayName.SetDefault("粉手电筒");
        ...
        public override void AI()
        {
            ...
            if(mplayer.SD2 > 0 && mplayer.SD == 16)
            {
                base.Projectile.timeLeft = 2;
            }
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                {
                    Lighting.AddLight(base.Projectile.Center + step * Projectile.velocity, (float)(255 - base.Projectile.alpha) * 2f / 255f * (30 - (float)step) / 30f * Lig, (float)(255 - base.Projectile.alpha) * 0.25f / 255f * (30 - (float)step) / 30f * Lig, (float)(255 - base.Projectile.alpha) * 1.16f / 255f * (30 - (float)step) / 30f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
