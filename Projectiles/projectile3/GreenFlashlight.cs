...
{
    public class GreenFlashlight : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            base.DisplayName.SetDefault("绿手电筒");
        ...
        public override void AI()
        {
            ...
            if (projectile.ai[0] == 0)
            {
                ...
                {
                    Lighting.AddLight(base.projectile.Center + step * projectile.velocity, (float)(255 - base.projectile.alpha) * 0f / 255f * (30 - (float)step) / 30f * Lig, (float)(255 - base.projectile.alpha) * 2.7f / 255f * (30 - (float)step) / 30f * Lig, (float)(255 - base.projectile.alpha) * 0.3f / 255f * (30 - (float)step) / 30f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
