...
{
    public class GrapeGun : ModProjectile
	{
		public override void SetStaticDefaults()
		{
            // base.DisplayName.SetDefault("葡萄子弹");
		}
		...
		public override void AI()
		{
            ...
            Lighting.AddLight(base.Projectile.Center, (float)(255 - base.Projectile.alpha) * 0.1f / 255f, (float)(255 - base.Projectile.alpha) * 0f / 255f, (float)(255 - base.Projectile.alpha) *0.4f / 255f);
		}
