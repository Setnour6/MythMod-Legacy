    ...
    public class EvilBomb : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 120; i++)
            {
                ...
                int num5 = Dust.NewDust(new Vector2(base.Projectile.position.X, base.Projectile.position.Y), base.Projectile.width, base.Projectile.height, Mod.Find<ModDust>("DarkF2").Type, 0f, 0f, 100, Color.White, (float)(4f * Math.Log10(Projectile.damage)));
            ...
            for (int i = 0; i < 15; i++)
            {
                ...
                int num5 = Dust.NewDust(new Vector2(base.Projectile.position.X, base.Projectile.position.Y), base.Projectile.width, base.Projectile.height, Mod.Find<ModDust>("DarkF2").Type, 0f, 0f, 100, Color.White, (float)(16f * Math.Log10(Projectile.damage)));
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                int u = Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, v.X, v.Y, Mod.Find<ModProjectile>("EvilSword3").Type, Projectile.damage / 5, 0f, Main.myPlayer, 0, 0f);
