...
{
    public class WatermelonStaff : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("西瓜喜糖法杖");
        }
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            if(Projectile.ai[0] == 1)
            {
                ...
                for(int i = 0;i < 8;i++)
                {
                    ...
                    int y = Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, v2.X, v2.Y, base.Mod.Find<ModProjectile>("WatermelonStaff").Type, (int)(Projectile.damage * 0.8f), 0, player.whoAmI, -1, 0f);
                }
            }
        }
