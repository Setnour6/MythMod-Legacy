    ...
    public class DarkStaff : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 3595)
            {
                ...
                int num = Dust.NewDust(vector - new Vector2(4, 4), 2, 2, Mod.Find<ModDust>("DarkF2").Type, 50f, 50f, 0, default(Color), (float)Projectile.scale * 2.4f);
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            for (int i = 0; i < 3; i++)
            {
                ...
                int num4 = Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, v.X, v.Y, base.Mod.Find<ModProjectile>("DarkStaff2").Type, base.Projectile.damage / 2, base.Projectile.knockBack, base.Projectile.owner, 0f, 20);
            }
