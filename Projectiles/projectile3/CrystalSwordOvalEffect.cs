...
{
    public class CrystalSwordOvalEffect : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft % 10 == 0)
            {
                ...
                Projectile.NewProjectile((vg + v2g * o).X, (vg + v2g * o).Y, 0, 0.01f, base.Mod.Find<ModProjectile>("CrystalSword6").Type, 70, 2f, Main.myPlayer, (float)Math.PI * 0.17f, 0f);
            }
        }
