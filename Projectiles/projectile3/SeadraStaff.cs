...
namespace MythMod.Projectiles.projectile3
{
    public class SeadraStaff : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
            ...
            int num = Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, 0, 0, Mod.Find<ModProjectile>("Storm").Type, Projectile.damage, 10f, Main.myPlayer, 10f, 25f);
