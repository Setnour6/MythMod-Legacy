...
{
    public class BurgundyFlashlight : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            base.DisplayName.SetDefault("紫红手电筒");
        ...
        public override void AI()
        {
            ...
            if(mplayer.SD2 > 0 && mplayer.SD == 22)
            {
                base.projectile.timeLeft = 2;
            }
            ...
            if (projectile.ai[0] == 0)
            {
                ...
                {
                    Lighting.AddLight(base.projectile.Center + step * projectile.velocity, (float)(255 - base.projectile.alpha) * 2f / 255f * (40 - (float)step) / 40f * Lig, (float)(255 - base.projectile.alpha) * 0f / 255f * (40 - (float)step) / 40f * Lig, (float)(255 - base.projectile.alpha) * 0.6f / 255f * (40 - (float)step) / 40f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
