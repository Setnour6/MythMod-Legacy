...
{
    public class FrozenFlashlight : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            // base.DisplayName.SetDefault("冰雪手电筒");
        ...
        public override void AI()
        {
            ...
            if(mplayer.SD2 > 0 && mplayer.SD == 10)
            {
                base.Projectile.timeLeft = 2;
            }
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                {
                    Lighting.AddLight(base.Projectile.Center + step * Projectile.velocity, (float)(255 - base.Projectile.alpha) * 0f / 255f * (30 - (float)step) / 30f * Lig, (float)(255 - base.Projectile.alpha) * 1.2f / 255f * (30 - (float)step) / 30f * Lig, (float)(255 - base.Projectile.alpha) * 1.425f / 255f * (30 - (float)step) / 30f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
