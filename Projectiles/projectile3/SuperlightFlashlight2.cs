...
{
    public class SuperlightFlashlight2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if(mplayer.SD2 > 0 && mplayer.SD == 18)
            {
                base.projectile.timeLeft = 2;
            }
            p.ChangeDir(base.projectile.direction);
            p.heldProj = base.projectile.whoAmI;
            Lighting.AddLight(base.projectile.Center, (float)(255 - base.projectile.alpha) * 0f / 255f, (float)(255 - base.projectile.alpha) * 1.8f / 255f, (float)(255 - base.projectile.alpha) * 0f / 255f);
            if (projectile.ai[0] == 0)
            {
                ...
                {
                    Lighting.AddLight(base.projectile.Center + step * projectile.velocity, (float)(255 - base.projectile.alpha) * 0.25f / 255f * (40 - (float)step) / 40f * Lig, (float)(255 - base.projectile.alpha) * 1.3f / 255f * (40 - (float)step) / 40f * Lig, (float)(255 - base.projectile.alpha) * 1.25f / 255f * (40 - (float)step) / 40f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
