...
{
    public class StrawberryGun : ModProjectile
	{
		public override void SetStaticDefaults()
		{
            base.DisplayName.SetDefault("草莓子弹");
		}
		...
		public override void AI()
		{
            ...
            Lighting.AddLight(base.projectile.Center, (float)(255 - base.projectile.alpha) * 0.45f / 255f, (float)(255 - base.projectile.alpha) * 0.05f / 255f, (float)(255 - base.projectile.alpha) * 0.05f / 255f);
		}
