    ...
    public class SuperCurseBall : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int k = 0; k <= 10; k++)
            {
                ...
                int num4 = Projectile.NewProjectile(base.projectile.Center.X + v.X, base.projectile.Center.Y + v.Y, 0, 0, base.mod.ProjectileType("GreenFireGas"), base.projectile.damage / 5, base.projectile.knockBack, base.projectile.owner, 0f, 0f);
