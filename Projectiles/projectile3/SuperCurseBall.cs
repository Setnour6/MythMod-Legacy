...
{
    public class SuperCurseBall : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int k = 0; k <= 10; k++)
            {
                ...
                int num4 = Projectile.NewProjectile(base.Projectile.Center.X + v.X, base.Projectile.Center.Y + v.Y, 0, 0, base.Mod.Find<ModProjectile>("GreenFireGas").Type, base.Projectile.damage / 5, base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
                Vector2 v2 = new Vector2(0, Main.rand.Next(3, 15)).RotatedByRandom(Math.PI * 2);
                int num5 = Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, v2.X, v2.Y, 95, base.Projectile.damage / 5, base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
                v2 = new Vector2(0, Main.rand.Next(3, 15)).RotatedByRandom(Math.PI * 2);
                int num6 = Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, v2.X, v2.Y, 96, base.Projectile.damage / 5, base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
