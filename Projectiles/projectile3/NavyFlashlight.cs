...
{
    public class NavyFlashlight : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            base.DisplayName.SetDefault("海蓝手电筒");
        ...
        public override void AI()
        {
            ...
            if(mplayer.SD2 > 0 && mplayer.SD == 19)
            {
                base.Projectile.timeLeft = 2;
            }
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                {
                     Lighting.AddLight(base.Projectile.Center + step * Projectile.velocity, (float)(255 - base.Projectile.alpha) * 0.9f / 255f * (10 - (float)step) / 3f * Lig, (float)(255 - base.Projectile.alpha) * 1f / 255f * (32 - (float)step) / 7f * Lig, (float)(255 - base.Projectile.alpha) * 0.95f / 255f * (40 - (float)step) / 7f * Lig);
                }
            }
            if(Main.mouseLeft)
            {
