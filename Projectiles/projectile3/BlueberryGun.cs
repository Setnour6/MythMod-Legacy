...
{
    public class BlueberryGun : ModProjectile
	{
		public override void SetStaticDefaults()
		{
            base.DisplayName.SetDefault("蓝莓子弹");
		}
		...
		public override void AI()
		{
            ...
            Lighting.AddLight(base.projectile.Center, (float)(255 - base.projectile.alpha) * 0.1f / 255f, (float)(255 - base.projectile.alpha) * 0f / 255f, (float)(255 - base.projectile.alpha) * 0.6f / 255f);
        }
