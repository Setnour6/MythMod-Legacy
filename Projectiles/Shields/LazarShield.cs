...
{
    public class LazarShield : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            base.DisplayName.SetDefault("激光盾");
        ...
        public override void AI()
        {
            ...
            {
                lazarCo = 240;
                int num = Projectile.NewProjectile(player.Center.X + projectile.velocity.X * 4f, player.Center.Y + projectile.velocity.Y * 4f, projectile.velocity.X, projectile.velocity.Y, 100, 90, 2, player.whoAmI, 0f, 0f);
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            spriteBatch.Draw(base.mod.GetTexture("Projectiles/Shields/激光盾Glow"), base.projectile.Center - Main.screenPosition, null, new Color((240 - lazarCo) / 240f, (240 - lazarCo) / 240f, (240 - lazarCo) / 240f, 0), projectile.rotation, new Vector2(15f, 15f), 1f, effects, 0f);
        }
    }
}
