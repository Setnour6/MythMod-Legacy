    ...
    public class 藤蔓友好 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			else
			{
				...
				{
					int num34 = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, base.projectile.velocity.X, base.projectile.velocity.Y, base.mod.ProjectileType("藤蔓散裂友好"), 444, 2f, Main.myPlayer, 0f, 0f);
