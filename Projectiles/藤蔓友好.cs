...
namespace MythMod.Projectiles
{
    ...
    public class 藤蔓友好 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			else
			{
				...
				{
					int num34 = Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, base.Projectile.velocity.X, base.Projectile.velocity.Y, base.Mod.Find<ModProjectile>("藤蔓散裂友好").Type, 444, 2f, Main.myPlayer, 0f, 0f);
