...
namespace MythMod.Projectiles
{
    ...
    public class 血琉璃长矛2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Main.player[base.Projectile.owner].itemAnimation < Main.player[base.Projectile.owner].itemAnimationMax / 3)
			{
                ...
                {
                    base.Projectile.localAI[0] = 1f;
                    Projectile.NewProjectile(base.Projectile.Center.X + base.Projectile.velocity.X * base.Projectile.ai[0], base.Projectile.Center.Y + base.Projectile.velocity.Y * base.Projectile.ai[0], base.Projectile.velocity.X * 1.4f, base.Projectile.velocity.Y * 1.4f, base.Mod.Find<ModProjectile>("血琉璃长矛3").Type, (int)((double)base.Projectile.damage * 0.8), base.Projectile.knockBack * 0.85f, base.Projectile.owner, 0f, 0f);
                }
			}
			else
			{
        ...
        {
            spriteBatch.Draw(base.Mod.GetTexture("Projectiles/血琉璃长矛_Glow"), base.Projectile.Center - Main.screenPosition, null, Color.Yellow * 1f, base.Projectile.rotation, new Vector2(0f, 0f), 1f, SpriteEffects.None, 0f);
        }
