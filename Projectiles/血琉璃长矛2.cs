    ...
    public class 血琉璃长矛2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Main.player[base.projectile.owner].itemAnimation < Main.player[base.projectile.owner].itemAnimationMax / 3)
			{
                ...
                {
                    base.projectile.localAI[0] = 1f;
                    Projectile.NewProjectile(base.projectile.Center.X + base.projectile.velocity.X * base.projectile.ai[0], base.projectile.Center.Y + base.projectile.velocity.Y * base.projectile.ai[0], base.projectile.velocity.X * 1.4f, base.projectile.velocity.Y * 1.4f, base.mod.ProjectileType("血琉璃长矛3"), (int)((double)base.projectile.damage * 0.8), base.projectile.knockBack * 0.85f, base.projectile.owner, 0f, 0f);
                }
			}
			else
			{
