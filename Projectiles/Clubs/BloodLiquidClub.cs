    ...
    public class BloodLiquidClub : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (lz % 30 == 29)
            {
                ...
                vk = vk / vk.Length() * 12f;
                int i = Projectile.NewProjectile(p.Center.X + vk.X, p.Center.Y + vk.Y, vk.X, vk.Y, mod.ProjectileType("BloodLiquidClub2"), projectile.damage, projectile.knockBack * 0.5f, p.whoAmI, 0, 0);
            }
