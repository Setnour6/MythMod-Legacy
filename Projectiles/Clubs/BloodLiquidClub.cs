...
{
    public class BloodLiquidClub : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int num25 = Dust.NewDust(base.Projectile.Center - new Vector2(4,4) + new Vector2(li,li).RotatedBy(Projectile.rotation), 0, 0, 64, 0, 0, 0, default(Color), 1.8f);
            ...
            if (lz % 10 == 1)
            {
                ...
                vk = vk / vk.Length() * 11f;
                int i = Projectile.NewProjectile(p.Center.X + vk.X, p.Center.Y + vk.Y, vk.X, vk.Y, 280, Projectile.damage, Projectile.knockBack * 0.5f, p.whoAmI, 0, 0);
            ...
            if (lz % 30 == 29)
            {
                ...
                vk = vk / vk.Length() * 12f;
                int i = Projectile.NewProjectile(p.Center.X + vk.X, p.Center.Y + vk.Y, vk.X, vk.Y, Mod.Find<ModProjectile>("BloodLiquidClub2").Type, Projectile.damage, Projectile.knockBack * 0.5f, p.whoAmI, 0, 0);
            }
        ...
        {
            spriteBatch.Draw(base.Mod.GetTexture("Glows/BloodLiquidClub_Glow"), base.Projectile.Center - Main.screenPosition, null, Color.White, base.Projectile.rotation + (float)Math.PI / 2f, new Vector2(32f, 32f), 1f, SpriteEffects.None, 0f);
        }
