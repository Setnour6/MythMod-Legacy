...
namespace MythMod.Projectiles.Clubs
{
    public class BlackWoodenClub : ModProjectile
    {
        ...
        {
            // base.DisplayName.SetDefault("乌木棍棒");
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            /*for (int i = 0; i < 15; i++)
            {
                Main.spriteBatch.Draw(texture, projectile.Center - Main.screenPosition + new Vector2(0f, projectile.gfxOffY) - projectile.velocity * i / 15f, null, new Color(1 - 1 / 15f * (float)i, 1 - 1 / 15f * (float)i, 1 - 1 / 15f * (float)i, (1 - 1 / 15f * (float)i)), projectile.rotation - i * 0.2f, new Vector2(32, 32), projectile.scale, effects, 0f);
            }*/
            return false;
        }
    }
