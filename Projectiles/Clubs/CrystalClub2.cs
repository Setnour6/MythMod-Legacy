    ...
    public class CrystalClub2 : ModProjectile
	{
		...
		public override void AI()
		{
            ...
            if(Projectile.timeLeft > 100)
            {
                ...
                int num25 = Dust.NewDust(base.Projectile.Center - new Vector2(4, 4) + new Vector2(li, li).RotatedBy(Projectile.rotation), 0, 0, 181, 0, 0, 0, default(Color), 1f * Omega * 4f);
            ...
            {
                float li = Main.rand.NextFloat(-32f, 32f);
                int num25 = Dust.NewDust(base.Projectile.Center - new Vector2(4, 4) + new Vector2(li, li).RotatedBy(Projectile.rotation), 0, 0, 181, 0, 0, 0, default(Color), 1f * Projectile.timeLeft / 100f * Omega * 4f);
                Main.dust[num25].noGravity = true;
                Main.dust[num25].velocity = new Vector2(li, li).RotatedBy(Math.PI / 2 + Projectile.rotation) * 0.3f * Omega * 2.5f;
            }
		...
		public override void Kill(int timeLeft)
		{
            ...
            Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, Main.rand.NextFloat(-10f, 10f), Main.rand.NextFloat(-10f, 10f), 94, base.Projectile.damage / 7, base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
            Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, Main.rand.NextFloat(-10f, 10f), Main.rand.NextFloat(-10f, 10f), 94, base.Projectile.damage / 7, base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
            Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, Main.rand.NextFloat(-10f, 10f), Main.rand.NextFloat(-10f, 10f), 94, base.Projectile.damage / 7, base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
            Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, Main.rand.NextFloat(-10f, 10f), Main.rand.NextFloat(-10f, 10f), 94, base.Projectile.damage / 7, base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
        }
