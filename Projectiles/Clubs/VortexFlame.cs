...
{
    public class VortexFlame : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            base.DisplayName.SetDefault("赤炎旋刃棍");
        }
        ...
        public override void AI()
        {
            ...
            int num25 = Dust.NewDust(base.projectile.Center - new Vector2(4,4) + new Vector2(li,li).RotatedBy(projectile.rotation), 0, 0, 6, 0, 0, 0, default(Color), 1.8f);
