...
{
    public class JungleClub : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int num25 = Dust.NewDust(base.Projectile.Center - new Vector2(4,4) + new Vector2(li,li).RotatedBy(Projectile.rotation), 0, 0, 39, 0, 0, 0, default(Color), 1.8f);
            ...
            if (Main.time % 10 == 1)
            {
                ...
                vk = vk / vk.Length() * 45f;
                int i = Projectile.NewProjectile(p.Center.X + vk.X, p.Center.Y + vk.Y, vk.X, vk.Y, 55, Projectile.damage, Projectile.knockBack * 0.5f, p.whoAmI, 0, 0);
