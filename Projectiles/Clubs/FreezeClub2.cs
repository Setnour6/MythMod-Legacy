        ...
        public override void Kill(int timeLeft)
        {
            if (timeLeft > 3)
            {
                ...
                for (int k = 0; k <= 20; k++)
                {
                    ...
                    int num4 = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, (float)((float)l * Math.Cos((float)a)) * 0.06f, (float)((float)l * Math.Sin((float)a)) * 0.06f, base.mod.ProjectileType("冰封球碎渣"), base.projectile.damage / 5, base.projectile.knockBack, base.projectile.owner, 0f, 30f);
