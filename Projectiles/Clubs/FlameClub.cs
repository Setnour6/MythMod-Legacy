...
{
    public class FlameClub : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            base.DisplayName.SetDefault("烈焰漩涡棒");
        }
        ...
        public override void AI()
        {
            ...
            int num25 = Dust.NewDust(base.Projectile.Center - new Vector2(4,4) + new Vector2(li,li).RotatedBy(Projectile.rotation), 0, 0, 6, 0, 0, 0, default(Color), 2.8f);
            Main.dust[num25].noGravity = true;
            Main.dust[num25].velocity = new Vector2(li, li).RotatedBy(Math.PI / 2 + Projectile.rotation) * 0.15f;
            int num26 = Dust.NewDust(base.Projectile.Center - new Vector2(4, 4) + new Vector2(li, li).RotatedBy(Projectile.rotation), 0, 0, 6, 0, 0, 0, default(Color), 2.8f);
            Main.dust[num26].noGravity = true;
            Main.dust[num26].velocity = new Vector2(li, li).RotatedBy(Math.PI / 2 + Projectile.rotation) * 0.15f;
