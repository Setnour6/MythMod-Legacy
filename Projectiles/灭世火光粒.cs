...
namespace MythMod.Projectiles
{
    ...
    public class 灭世火光粒 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Lighting.AddLight(base.Projectile.Center, (float)(255 - base.Projectile.alpha) * 0f / 255f, (float)(255 - base.Projectile.alpha) * 0.375f / 255f, (float)(255 - base.Projectile.alpha) * 0.5f / 255f);
		}
