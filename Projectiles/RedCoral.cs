    ...
    public class RedCoral : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if(Main.rand.Next(0, (int)(20 * (base.Projectile.ai[0] + 1) * (base.Projectile.ai[0] + 1))) == 5 && base.Projectile.ai[0] < 5 && Projectile.timeLeft <= 420 && !WeakeningFlag)
            {
                ...
                {
                    Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, v.X, v.Y, base.Mod.Find<ModProjectile>("RedCoral").Type, base.Projectile.damage, base.Projectile.knockBack, Main.myPlayer, base.Projectile.ai[0] + 1, 0f);
                }
