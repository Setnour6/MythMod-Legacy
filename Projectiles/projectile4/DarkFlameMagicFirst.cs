...
namespace MythMod.Projectiles.projectile4
{
    public class DarkFlameMagicFirst : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.Center.X + 16, Projectile.Center.Y + 16, 0, 0, Mod.Find<ModProjectile>("DarkFlameMagic" + Main.rand.Next(4).ToString()).Type, 27, 0f, Main.myPlayer, 0, 0f);
        }
