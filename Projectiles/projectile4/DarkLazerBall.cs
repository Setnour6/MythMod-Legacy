                    ...
                    if (Sca > 0.1f)
                    {
                        for (int k = 0; k < Leng - 52; k += 16)
                        {
                            ...
                            else
                            {
                                ...
                                if (!Main.gamePaused)
                                {
                                    int num = Dust.NewDust(Projectile.Center + new Vector2(0, -r - k - 8).RotatedBy(Math.PI * n * (i + 1)) - new Vector2(4, 4), 2, 2, Mod.Find<ModDust>("DarkF").Type, 50f, 50f, 0, default(Color), (float)Projectile.scale * 2.4f);
                                    ...
                                    {
                                        Projectile.NewProjectile(Main.player[pl].Center.X, Main.player[pl].Center.Y, 0, 0, Mod.Find<ModProjectile>("Hit").Type, Projectile.damage, 0f, Main.myPlayer, 0f, 0f);
                                    }
                                }
                            }
                        }
                    ...
                    if (Sca > 0.1f)
                    {
                        ...
                        for (int k = 0; k < Leng - 52; k += 16)
                        {
                            ...
                            else
                            {
                                ...
                                if (!Main.gamePaused)
                                {
                                    int num = Dust.NewDust(Projectile.Center + new Vector2(0, -r - k - 8).RotatedBy(Math.PI * n * (i + 1)) - new Vector2(4, 4), 2, 2, Mod.Find<ModDust>("DarkF").Type, 50f, 50f, 0, default(Color), (float)Projectile.scale * 2.4f / 30f * Projectile.timeLeft);
                                    Main.dust[num].velocity *= 0.0f;
                                    Main.dust[num].noGravity = true;
                                    Main.dust[num].alpha = 150;
                                    Vector2 O = Projectile.Center;
