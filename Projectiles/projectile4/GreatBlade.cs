...
{
    public class GreatBlade : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            base.DisplayName.SetDefault("新手太刀");
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = Mod.GetTexture("Projectiles/projectile4/CatastropheWheelKnife");
            ...
            for (int y = 0;y < Times;y++)
            {
                ...
                spriteBatch.Draw(TextureAssets.Projectile[Projectile.type].Value, v1 + new Vector2(15, 15) - Main.screenPosition, new Rectangle(0, 10 - (int)(y / (float)Times * 10), 2, 30), new Color(lig * (Times - y) / 250f, lig * (Times - y) / 250f, lig * (Times - y) / 250f, lig * (Times - y) / 150f), Rot2, new Vector2(1, 15), Projectile.scale, SpriteEffects.None, 0f);
                spriteBatch.Draw(TextureAssets.Projectile[Projectile.type].Value, v1 + new Vector2(15, 15) - Main.screenPosition, new Rectangle(0, 10 - (int)(y / (float)Times * 10), 2, 30), new Color(lig * (Times - y) / 350f, lig * (Times - y) / 350f, lig * (Times - y) / 350f, 0), Rot2, new Vector2(1, 15), Projectile.scale, SpriteEffects.None, 0f);
            }
            return false;
        }
