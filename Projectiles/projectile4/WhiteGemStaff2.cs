...
namespace MythMod.Projectiles.projectile4
{
    public class WhiteGemStaff2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int num = Dust.NewDust(projectile.Center - new Vector2(4, 4) + new Vector2(0, 12).RotatedBy(projectile.timeLeft / 4f), 2, 2, mod.DustType("WhiteEffect2"), 0, 0, 0, default(Color), 1f);
            Main.dust[num].noGravity = false;
            Main.dust[num].velocity *= 0;
            int num20 = Dust.NewDust(projectile.Center - new Vector2(4, 4) - new Vector2(0, 12).RotatedBy(projectile.timeLeft / 4f), 2, 2, mod.DustType("WhiteEffect2"), 0, 0, 0, default(Color), 1f);
            Main.dust[num20].noGravity = false;
            Main.dust[num20].velocity *= 0;
            int num21 = Dust.NewDust(projectile.Center - new Vector2(4, 4), 2, 2, mod.DustType("WhiteEffect2"), 0, 0, 0, default(Color), 1.5f);
            Main.dust[num21].velocity *= 0;
            int num22 = Dust.NewDust(projectile.Center - new Vector2(4, 4) + new Vector2(0, Main.rand.NextFloat(0, 8f)).RotatedByRandom(Math.PI * 2), 2, 2, mod.DustType("WhiteEffect2"), 0, 0, 0, default(Color), 1.5f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int a = 0; a < 90; a++)
            {
                ...
                int num = Dust.NewDust(vector - new Vector2(4, 4), 2, 2, mod.DustType("WhiteEffect2"), v.X, v.Y, 0, default(Color), 2f * Main.rand.NextFloat(0.4f, 1.2f));
                Main.dust[num].noGravity = false;
            ...
            for (int a = 0; a < 20; a++)
            {
                ...
                int num = Dust.NewDust(vector - new Vector2(4, 4) + v * 10f, 2, 2, mod.DustType("WhiteEffect"), v.X, v.Y, 0, default(Color), 1.2f * Main.rand.NextFloat(0.8f, 1.2f));
                Main.dust[num].noGravity = false;
                Main.dust[num].velocity *= 0;
            }
            for (int a = 0; a < 10; a++)
            ...
            if (false)
            {
                for (int a = 0; a < 200; a++)
                {
                    ...
                    int num = Dust.NewDust(vector - new Vector2(4, 4) + v, 2, 2, mod.DustType("WhiteEffect"), v.X, v.Y, 0, default(Color), 1.5f);
                    Main.dust[num].noGravity = false;
