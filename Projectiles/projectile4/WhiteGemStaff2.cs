...
{
    public class WhiteGemStaff2 : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("WhiteGemStaff");
        }
        ...
        public override void AI()
        {
            ...
            int num = Dust.NewDust(Projectile.Center - new Vector2(4, 4) + new Vector2(0, 12).RotatedBy(Projectile.timeLeft / 4f), 2, 2, Mod.Find<ModDust>("WhiteEffect2").Type, 0, 0, 0, default(Color), 1f);
            Main.dust[num].noGravity = false;
            Main.dust[num].velocity *= 0;
            int num20 = Dust.NewDust(Projectile.Center - new Vector2(4, 4) - new Vector2(0, 12).RotatedBy(Projectile.timeLeft / 4f), 2, 2, Mod.Find<ModDust>("WhiteEffect2").Type, 0, 0, 0, default(Color), 1f);
            Main.dust[num20].noGravity = false;
            Main.dust[num20].velocity *= 0;
            int num21 = Dust.NewDust(Projectile.Center - new Vector2(4, 4), 2, 2, Mod.Find<ModDust>("WhiteEffect2").Type, 0, 0, 0, default(Color), 1.5f);
            Main.dust[num21].velocity *= 0;
            int num22 = Dust.NewDust(Projectile.Center - new Vector2(4, 4) + new Vector2(0, Main.rand.NextFloat(0, 8f)).RotatedByRandom(Math.PI * 2), 2, 2, Mod.Find<ModDust>("WhiteEffect2").Type, 0, 0, 0, default(Color), 1.5f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int a = 0; a < 90; a++)
            {
                ...
                int num = Dust.NewDust(vector - new Vector2(4, 4), 2, 2, Mod.Find<ModDust>("WhiteEffect2").Type, v.X, v.Y, 0, default(Color), 2f * Main.rand.NextFloat(0.4f, 1.2f));
                Main.dust[num].noGravity = false;
            ...
            for (int a = 0; a < 20; a++)
            {
                ...
                int num = Dust.NewDust(vector - new Vector2(4, 4) + v * 10f, 2, 2, Mod.Find<ModDust>("WhiteEffect").Type, v.X, v.Y, 0, default(Color), 1.2f * Main.rand.NextFloat(0.8f, 1.2f));
                Main.dust[num].noGravity = false;
                Main.dust[num].velocity *= 0;
            }
            for (int a = 0; a < 10; a++)
            ...
            if (false)
            {
                ...
                {
                    Vector2 vector = base.Projectile.Center;
                    Vector2 v = new Vector2(0, 32).RotatedByRandom(Math.PI * (double)a / 100d);
                    int num = Dust.NewDust(vector - new Vector2(4, 4) + v, 2, 2, Mod.Find<ModDust>("WhiteEffect").Type, v.X, v.Y, 0, default(Color), 1.5f);
                    Main.dust[num].noGravity = false;
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            if (bars.Count > 2)
            {
                ...
                Main.graphics.GraphicsDevice.Textures[0] = MythMod.MainColorWhite;
