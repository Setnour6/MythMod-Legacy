    ...
    public class RedCrack2 : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            for (int y = 0; y < Times; y++)
            {
                ...
                spriteBatch.Draw(Main.projectileTexture[projectile.type], v1 - Main.screenPosition, new Rectangle(0, x, 10, 10 - 2 * x), new Color(lig * (Times - y) / 10f, lig * (Times - y) / 10f, lig * (Times - y) / 10f, 0), Rot2, new Vector2(5, 5 - x), projectile.scale, SpriteEffects.None, 0f);
