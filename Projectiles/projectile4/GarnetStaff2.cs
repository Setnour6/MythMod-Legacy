...
namespace MythMod.Projectiles.projectile4
{
    public class GarnetStaff2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int num = Dust.NewDust(projectile.Center - new Vector2(4, 4) + new Vector2(0, 12).RotatedBy(projectile.timeLeft / 4f), 2, 2, mod.DustType("GarnetEffect2"), 0, 0, 0, default(Color), 1f);
            Main.dust[num].noGravity = false;
            Main.dust[num].velocity *= 0;
            int num20 = Dust.NewDust(projectile.Center - new Vector2(4, 4) - new Vector2(0, 12).RotatedBy(projectile.timeLeft / 4f), 2, 2, mod.DustType("GarnetEffect2"), 0, 0, 0, default(Color), 1f);
            Main.dust[num20].noGravity = false;
            Main.dust[num20].velocity *= 0;
            int num21 = Dust.NewDust(projectile.Center - new Vector2(4, 4), 2, 2, mod.DustType("GarnetEffect2"), 0, 0, 0, default(Color), 1.5f);
            Main.dust[num21].velocity *= 0;
            int num22 = Dust.NewDust(projectile.Center - new Vector2(4, 4) + new Vector2(0, Main.rand.NextFloat(0, 8f)).RotatedByRandom(Math.PI * 2), 2, 2, mod.DustType("GarnetEffect2"), 0, 0, 0, default(Color), 1.5f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i <= 32; i++)
            {
                ...
                int num5 = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, (float)num2, (float)num3, base.mod.ProjectileType("GarnetGemDust"), (int)((double)base.projectile.damage * 0.1f), base.projectile.knockBack, base.projectile.owner, 0f, 0f);
            ...
            for (int a = 0; a < 20; a++)
            {
                ...
                int num = Dust.NewDust(vector - new Vector2(4, 4) + v * 10f, 2, 2, mod.DustType("GarnetEffect"), v.X, v.Y, 0, default(Color), 1.2f * Main.rand.NextFloat(0.8f, 1.2f));
                Main.dust[num].noGravity = false;
                Main.dust[num].velocity *= 0;
            }
        }
