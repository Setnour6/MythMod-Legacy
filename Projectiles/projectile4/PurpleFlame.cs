        ...
        public override void AI()
		{
            if (Projectile.timeLeft == 895)
            {
                ...
                if (Cou > 3)
                {
                    ...
                    Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, 0, 0, Mod.Find<ModProjectile>("PurpleFlameLage").Type, Projectile.damage, Projectile.knockBack, 255, 0f, 0f);
                }
            }
