...
{
    public class GreenGemStaff2 : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("GreenGemStaff");
        }
        ...
        public override void AI()
        {
            ...
            int num = Dust.NewDust(Projectile.Center - new Vector2(4, 4) + new Vector2(0, 12).RotatedBy(Projectile.timeLeft / 4f), 2, 2, Mod.Find<ModDust>("GreenEffect2").Type, 0, 0, 0, default(Color), 1f);
            Main.dust[num].noGravity = false;
            Main.dust[num].velocity *= 0;
            int num20 = Dust.NewDust(Projectile.Center - new Vector2(4, 4) - new Vector2(0, 12).RotatedBy(Projectile.timeLeft / 4f), 2, 2, Mod.Find<ModDust>("GreenEffect2").Type, 0, 0, 0, default(Color), 1f);
            Main.dust[num20].noGravity = false;
            Main.dust[num20].velocity *= 0;
            int num21 = Dust.NewDust(Projectile.Center - new Vector2(4, 4), 2, 2, Mod.Find<ModDust>("GreenEffect2").Type, 0, 0, 0, default(Color), 1.5f);
            Main.dust[num21].velocity *= 0;
            int num22 = Dust.NewDust(Projectile.Center - new Vector2(4, 4) + new Vector2(0, Main.rand.NextFloat(0, 8f)).RotatedByRandom(Math.PI * 2), 2, 2, Mod.Find<ModDust>("GreenEffect2").Type, 0, 0, 0, default(Color), 1.5f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i <= 32; i++)
            {
                ...
                int num5 = Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, (float)num2, (float)num3, base.Mod.Find<ModProjectile>("GreenGemDust").Type, (int)((double)base.Projectile.damage * 0.1f), base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
            ...
            for (int a = 0; a < 90; a++)
            {
                ...
                int num = Dust.NewDust(vector - new Vector2(4, 4), 2, 2, Mod.Find<ModDust>("GreenEffect2").Type, v.X, v.Y, 0, default(Color), 2f * Main.rand.NextFloat(0.4f, 1.2f));
                Main.dust[num].noGravity = false;
            ...
            for (int a = 0; a < 20; a++)
            {
                ...
                int num = Dust.NewDust(vector - new Vector2(4, 4) + v * 10f, 2, 2, Mod.Find<ModDust>("GreenEffect").Type, v.X, v.Y, 0, default(Color), 1.2f * Main.rand.NextFloat(0.8f, 1.2f));
                Main.dust[num].noGravity = false;
                Main.dust[num].velocity *= 0;
            }
        }
