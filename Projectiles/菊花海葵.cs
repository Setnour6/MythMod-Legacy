...
namespace MythMod.Projectiles
{
    ...
    public class 菊花海葵 : ModProjectile
	{
        ...
        public override void AI()
		{
            ...
            {
                Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y - 5f, Main.rand.Next(-100, 100) / 150f, -5f, base.Mod.Find<ModProjectile>("海葵粒子").Type, base.Projectile.damage, base.Projectile.knockBack, Main.myPlayer, 0f, 0f);
            }
