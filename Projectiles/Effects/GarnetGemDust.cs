...
{
    public class GarnetGemDust : ModProjectile
	{
		public override void SetStaticDefaults()
		{
            // base.DisplayName.SetDefault("紫红宝石火粒");
		}
		...
		{
            Lighting.AddLight(base.Projectile.Center, (float)(255 - base.Projectile.alpha) * 0.6f / 255f * Projectile.timeLeft / 60f, (float)(255 - base.Projectile.alpha) * 0f / 255f * Projectile.timeLeft / 60f, (float)(255 - base.Projectile.alpha) * 0.6f / 255f * Projectile.timeLeft / 60f);
