...
{
    public class BlueGemDust2 : ModProjectile
	{
		public override void SetStaticDefaults()
		{
            base.DisplayName.SetDefault("蓝宝石火粒");
		}
		...
		{
            Lighting.AddLight(base.Projectile.Center, (float)(255 - base.Projectile.alpha) * 0f / 255f, (float)(255 - base.Projectile.alpha) * 0f / 255f, (float)(255 - base.Projectile.alpha) * 1.2f / 255f * Projectile.timeLeft / 60f);
            ...
            Omega += Main.rand.NextFloat(-0.008f, 0.008f);
