...
{
    public class GreenGemDust : ModProjectile
	{
		public override void SetStaticDefaults()
		{
            base.DisplayName.SetDefault("绿宝石火粒");
		}
		...
		{
            Lighting.AddLight(base.projectile.Center, (float)(255 - base.projectile.alpha) * 0f / 255f, (float)(255 - base.projectile.alpha) * 1.0f / 255f, (float)(255 - base.projectile.alpha) * 0.3f / 255f);
