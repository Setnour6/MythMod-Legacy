...
{
    public class DiamondDust : ModProjectile
	{
		public override void SetStaticDefaults()
		{
            base.DisplayName.SetDefault("钻火粒");
		}
		...
		public override Color? GetAlpha(Color lightColor)
		{
            if(K == 0)
            {
                return new Color?(new Color(175, 115, 115, 0));
            }
            else if(K == 1)
            {
                return new Color?(new Color(115, 175, 115, 0));
            }
            else
            {
                return new Color?(new Color(115, 115, 175, 0));
            }
		}
