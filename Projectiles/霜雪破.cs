...
namespace MythMod.Projectiles
{
    ...
    public class 霜雪破 : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int k = 0; k <= 6; k++)
			{
                Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y,(float)Math.Sin(k / 3f * Math.PI + num2) * 7f,(float)Math.Cos(k / 3f * Math.PI + num2) * 7f, base.Mod.Find<ModProjectile>("霜雪破散裂").Type, base.Projectile.damage / 4, base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
			}
		}
