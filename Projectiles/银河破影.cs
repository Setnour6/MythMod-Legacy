...
namespace MythMod.Projectiles
{
    ...
    public class 银河破影 : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			for (int i = 0; i <= 5; i++)
			{
				...
				Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, (float)num2, (float)num3, base.Mod.Find<ModProjectile>("银河碎片").Type, (int)((double)base.Projectile.damage * 0.6f), base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
				if (Main.rand.Next(0, 11) == 1)
				{
					num4 = (float)(Main.rand.Next(0, 1000));
			        num1 = Main.rand.Next(0, 1000) / 500f;
			        num2 = Math.Sin((double)num1 * Math.PI) * num4 / 90f;
			        num3 = Math.Cos((double)num1 * Math.PI) * num4 / 90f;
				    Projectile.NewProjectile(base.Projectile.Center.X, base.Projectile.Center.Y, (float)num2, (float)num3, base.Mod.Find<ModProjectile>("银河破影II").Type, (int)((double)base.Projectile.damage * 0.95f), base.Projectile.knockBack, base.Projectile.owner, 0f, 0f);
				}
			}
		}
	}
