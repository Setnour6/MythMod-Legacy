    ...
    public class 银河破影 : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			for (int i = 0; i <= 5; i++)
			{
				...
				Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, (float)num2, (float)num3, base.mod.ProjectileType("银河碎片"), (int)((double)base.projectile.damage * 0.6f), base.projectile.knockBack, base.projectile.owner, 0f, 0f);
				if (Main.rand.Next(0, 11) == 1)
				{
				    ...
				    Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, (float)num2, (float)num3, base.mod.ProjectileType("银河破影II"), (int)((double)base.projectile.damage * 0.95f), base.projectile.knockBack, base.projectile.owner, 0f, 0f);
				}
			}
		}
	}
