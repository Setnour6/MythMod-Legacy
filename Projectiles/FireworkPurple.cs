...
{
    //135596
    public class FireworkPurple : ModProjectile
    {
        //4444444
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("烟花火球紫");
        }
        //7359668
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
            ...
            {
                spriteBatch.Draw(base.mod.GetTexture("Projectiles/烟花火球紫light"), base.projectile.Center - Main.screenPosition, null, new Color(projectile.scale * (projectile.timeLeft - 300) / (1800f * z * z), projectile.scale * (projectile.timeLeft - 300) / (1800f * z * z), projectile.scale * (projectile.timeLeft - 300) / (1800f * z * z), 0), base.projectile.rotation, new Vector2(56f, 56f), 1 + (800 - projectile.timeLeft) / 200f * z, SpriteEffects.None, 0f);
            }
            return false;
		}
    }
