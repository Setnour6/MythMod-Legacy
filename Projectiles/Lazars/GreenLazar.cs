...
namespace MythMod.Projectiles.Lazars
{
    public class GreenLazar : ModProjectile
	{
		public override void SetStaticDefaults()
		{
            base.DisplayName.SetDefault("GreenLazar");
		}
		...
		public override void AI()
		{
            ...
            Lighting.AddLight(base.Projectile.Center, (float)(255 - base.Projectile.alpha) * 0f / 255f, (float)(255 - base.Projectile.alpha) * 1f / 255f, (float)(255 - base.Projectile.alpha) * 0f / 255f);
		}
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (base.Projectile.getRect().Intersects(value))
            {
                ...
                {
                    num4 = 25f / 10f * (float)base.Projectile.timeLeft;
                }
