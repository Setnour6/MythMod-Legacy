...
{
    public class CrimsonTusk1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.velocity.Y == 0 && X == 0)
            {
                for (int u =0;u < 15;u++)
                {
                    int r = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y + 22f) + base.Projectile.velocity * 3f, 0, 0, 117, (float)Main.rand.Next(-2000, 2000) / 6000f, -3f, 0, default(Color), 1.1f);
