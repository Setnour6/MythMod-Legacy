        ...
        public override void AI()
        {
            ...
            if (base.Projectile.friendly)
            {
                for (int j = 0; j < 200; j++)
                {
                    ...
                    {
                        int num = Projectile.NewProjectile(Main.npc[j].Center.X, Main.npc[j].Center.Y, 0, 0, base.Mod.Find<ModProjectile>("CrackSoundWave").Type, base.Projectile.damage, base.Projectile.knockBack, Main.myPlayer, 10, 0f);
            ...
            else
            {
                ...
                {
                    int num3 = Projectile.NewProjectile(Main.player[num5].Center.X, Main.player[num5].Center.Y, 0, 0, base.Mod.Find<ModProjectile>("CrackSoundWave").Type, base.Projectile.damage, base.Projectile.knockBack, Main.myPlayer, 10, 0f);
